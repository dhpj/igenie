...
class Profile extends CB_Controller {
	...
	*/
	...
	public function index()
	{
		...
		$page_cfg['base_url'] = '';
        //ib플래그 
		$page_cfg['total_rows'] = $this->Biz_dhn_model->get_table_count(config_item('ib_profile'), "spf_key<>'' and spf_use='Y' and spf_mem_id=?", array($this->member->item('mem_id')));
		/*
		$page_cfg['total_rows'] = $this->Biz_dhn_model->get_table_count("cb_wt_send_profile_dhn a inner join
