<?php
class Talk_m extends CB_Controller {
    /**
     * 모델을 로딩합니다
     */
...
//         }
        ...
        $view['tpl'] = $this->db->query("select a.*, b.spf_friend, b.spf_key_type, b.spf_sms_callback, cc.* from cb_wt_template_dhn a inner join cb_wt_send_profile_dhn b on a.tpl_profile_key=b.spf_key and b.spf_use='Y' left join cb_coupon cc on cc.cc_tpl_id = a.tpl_id where tpl_code in ('d022', 'd033', 'd30') and tpl_profile_key='f89b5a20b11774df97059b879e51562e6fb4b98f' order by tpl_id desc")->result();
