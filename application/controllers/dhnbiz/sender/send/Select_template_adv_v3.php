<?php
class Select_template_adv_v3 extends CB_Controller {
    /**
     * 모델을 로딩합니다
     */
    ...
    public function index()
    {
		...
		if($view['home_code'] != ""){
            ...
            // log_message("ERROR", $_SERVER['REQUEST_URI'] ." > home_url : ".'http://'. $_SERVER['HTTP_HOST'] ."/smart/shome/". $sh_code);
			// $view['home_url'] = '';
		}
        ...
        //ib플래그
		$sql = "SELECT DISTINCT cwtc.tci_btn_cnt FROM ".config_item('ib_categoryid')." cwtc WHERE cwtc.tci_type ='T' and cwtc.tci_btn_cnt < 2 ORDER BY cwtc.tci_btn_cnt ASC";
		//$view['max_btn_cnt'] = $this->db->query($sql)->row()->max_btn_cnt;
