<?php
class Select_template_img_adv_v2 extends CB_Controller {
    /**
     * 모델을 로딩합니다
     */
    ...
    public function index()
    {
        ...
        //ib플래그
		$sql = "SELECT DISTINCT cwtc.tci_btn_cnt FROM ".config_item('ib_categoryid')." cwtc WHERE cwtc.tci_type ='I' ORDER BY cwtc.tci_btn_cnt ASC";
		//$view['max_btn_cnt'] = $this->db->query($sql)->row()->max_btn_cnt;
		...
		$skin = "select_template_img_adv_v2";
		$add = $view['add'];
		if($add != "") $skin .= $add;
