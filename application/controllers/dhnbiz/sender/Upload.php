...
class Upload extends CB_Controller {
    ...
    public function index()
    {
        ...
        if($templ_profile) {
            $upload_type = "at";
            $tmpl = $this->db->query("select * from cb_wt_template_dhn where tpl_inspect_status='APR' and tpl_use='Y' and tpl_id=? and tpl_profile_key=? and tpl_code=?", array($templ_id, $templ_profile, $templ_code))->row();
            /* �˸����� ��� ���ø��� ������ ó������ ���� */
        ...
        */
        ...
        if($upload_type=="ft") {
            ...
            echo '{"status": "success", "ft_count": '.$ft_count.', "mms_count": '.$mms_count.', "lms_count": '.$lms_count.', "sms_count": '.$sms_count.',
			       "ft_img_count": '.$ft_img_count.', "coin": "'.$coin.'", "col_len": '.$col_len.', "tot_row_len": '.$tot_row_len.', "ex_row_len": '.$ex_row_len.', "row_len": '.$ok.', "tel_err_cnt" : '.$phone_error.' }';
        } else {
            echo '{"status": "success", "at_count": '.$ft_count.', "lms_count": '.$lms_count.', "sms_count": '.$sms_count.', "coin": "'.$coin.'", "col_len": '.$col_len.', "nrow_len": '.$ok.', "tel_err_cnt" : '.$phone_error.' }';
        }
    }
