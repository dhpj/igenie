<?php
class Partner2 extends CB_Controller {
    /**
     * 모델을 로딩합니다
     */
    ...
    public function inc_lists() {
        ...
        $this->load->view('biz/partner2/inc_lists',$view);
    }
    ...
    function partner_save($new=false)
    {
        ...
        if ($this->db->error()['code'] > 0) {
            ...
            header("Location: /biz/partner2/lists");
        }
    }
    ...
    public function inc_recipient_lists() {
        ...
        $this->load->view('biz/partner2/inc_recipient_lists',$view);
    }
