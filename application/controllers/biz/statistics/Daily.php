	...
	public function index()
	{
	    ...
	    if($this->member->item('mem_level')==17) {
	        ...
	        if ($sales_cnt > 0) {
	            ...
	            $view['list'] = $this->Biz_model->get_sales_daily_report_new($view['param']);
	        } else {
	            $view['list'] = $this->Biz_model->get_daily_report_new( $view['param']);
	        }
	    ...
	    $sql = "select a.ds_id, a.ds_dbo_id, a.ds_name,
                ...
                from dhn_salesperson a left join dhn_branch_office b on a.ds_dbo_id=b.dbo_id where ds_task_state<>'L' order by b.dbo_id, a.ds_id, a.ds_name";
