	...
	*/
	...
	public function select_template()
	{
		...
		if($tmp_profile && $tmp_code) {
			...
			$view['rs'] = $this->db->query("select a.*, b.spf_friend, b.spf_key_type, b.spf_sms_callback from cb_wt_template a inner join cb_wt_send_profile b on a.tpl_profile_key=b.spf_key and b.spf_use='Y' where tpl_mem_id=? order by tpl_id desc limit 1", array($this->member->item('mem_id')))->row();
		}
