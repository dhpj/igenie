...
class Image_delete extends CB_Controller {
	...
	*/
	...
	public function index()
	{
		...
		$mem = $this->db->query("SELECT spf_key FROM cb_wt_send_profile where spf_use='Y' and spf_mem_id=? order by spf_datetime asc limit 1", array($this->member->item('mem_id')))->row();
		$pf_key = $mem->spf_key;
