...
class History extends CB_Controller {
    ...
    public function index()
    {
        ...
        $sql = "
			...
			where ".$where." order by (case when a.mst_reserved_dt <> '00000000000000' then a.mst_reserved_dt else DATE_FORMAT(a.mst_datetime, '%Y%m%d%H%i%s')  end) desc, mst_id desc limit ".(($view['param']['page'] - 1) * $view['perpage']).", ".$view['perpage'];
