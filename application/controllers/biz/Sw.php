...
exit;
		...
		$this->db->query("update cb_wt_template set tpl_contents=?, tpl_button=? where tpl_profile_key=? and tpl_code=?", array($tmpl->data->templateContent, $tmpl->data->buttons, $pf_key, $tpl_code));
