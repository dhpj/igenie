...
(SELECT distinct  a.mem_id
	...
	public function add_process()
	{
		...
		foreach($json as $tr) {
			...
			$data['tpl_id'] = ($partner) ? $this->Biz_model->get_table_next_id('cb_wt_template', 'tpl_id', "", array()) : 1;	//'tpl_mem_id=?', array($partner->spf_mem_id)) : 0;
			...
			$this->db->insert('wt_template', $data);
