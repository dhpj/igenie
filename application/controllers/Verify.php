        ...
        if ( ! element('mae_id', $result)) {
            ...
            if ( ! element('mem_id', $dbmember)) {
                ...
                $this->Member_auth_email_model->update(element('mae_id', $result), $updateemail);
					...
					$this->Biz_model->make_msg_log_table(element('mem_userid', $dbmember));
					$this->Biz_model->make_customer_book(element('mem_userid', $dbmember));
					$this->Biz_model->make_user_image_table(element('mem_userid', $dbmember));
					$this->Biz_model->make_user_deposit_table(element('mem_userid', $dbmember));
					$this->Biz_model->make_send_cache_table(element('mem_userid', $dbmember));
					/*-----------------------------------------------*/
