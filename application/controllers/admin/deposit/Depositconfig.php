 ...
 */
class Depositconfig extends CB_Controller
{
     ...
     * 페이지 이동시 필요한 정보입니다
     */
    public $pagedir = 'deposit/depositconfig';

    /**
     * 모델을 로딩합니다
     */
    protected $models = array('Deposit_config', 'Config');
    ...
    public function index()
    {
        ...
        // 이벤트 라이브러리를 로딩합니다
        $eventname = 'event_admin_deposit_depositconfig_index';
...
50000:50000';
            ...
            $this->Deposit_config_model->save($initdata);
    ...
    {
        // 이벤트 라이브러리를 로딩합니다
        $eventname = 'event_admin_deposit_depositconfig_layout';
        $this->load->event($eventname);
    ...
    {
        // 이벤트 라이브러리를 로딩합니다
        $eventname = 'event_admin_deposit_depositconfig_smsconfig';
        $this->load->event($eventname);
    ...
    {
        // 이벤트 라이브러리를 로딩합니다
        $eventname = 'event_admin_deposit_depositconfig_paymentconfig';
        $this->load->event($eventname);
        ...
        if ($this->form_validation->run() === false) {
            ...
            $array = array(
                ...
                'payment_bank_info', 'pg_inicis_websign'
            );
            foreach ($array as $value) {
                $savedata[$value] = $this->input->post($value, null, '');
            }
    ...
    {
        // 이벤트 라이브러리를 로딩합니다
        $eventname = 'event_admin_deposit_depositconfig_alarm';
        $this->load->event($eventname);
