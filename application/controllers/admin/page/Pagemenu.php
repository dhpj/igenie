...
class Pagemenu extends CB_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() === false) {
            ...
            $men_show = $this->input->post('men_show') ? $this->input->post('men_show') : 'N';
            $men_allow_lv = $this->input->post('men_allow_lv') ? $this->input->post('men_allow_lv') : 1;
            $men_max_lv = $this->input->post('men_max_lv') ? $this->input->post('men_max_lv') : 100;
            ...
            $updatedata = array(
                ...
                'men_show' => $men_show,
                'men_allow_lv' => $men_allow_lv,
                'men_max_lv' => $men_max_lv,
    ...
    public function listupdate()
    {
        ...
        if ($this->input->post('chk') && is_array($this->input->post('chk'))) {
            ...
            $men_show = $this->input->post('men_show');
            $men_allow_lv = $this->input->post('men_allow_lv');
            $men_max_lv = $this->input->post('men_max_lv');
            ...
            foreach ($this->input->post('chk') as $val) {
                if ($val) {
					...
					$men_show_update = element($val, $men_show) ? element($val, $men_show) : 'N';
					$men_allow_lv_update = element($val, $men_allow_lv) ? element($val, $men_allow_lv) : 1;
					$men_max_lv_update = element($val, $men_max_lv) ? element($val, $men_max_lv) : 100;
                    $updatedata = array(
                        ...
                        'men_show' => $men_show_update,
                        'men_allow_lv' => $men_allow_lv_update,
                        'men_max_lv' => $men_max_lv_update,
