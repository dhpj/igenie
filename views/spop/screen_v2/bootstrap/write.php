      ...
      <div class="wl_r_preview">
        ...
        <div class="pre_box_wrap" id="pre_box_area">
			...
			<div class="pre_box3" id="pre_goods_box-<?=$box_seq?>">
              ...
              <!-- <div id="pre_goods_more-<?=$box_seq?>" onclick="conner_more('<?=$box_seq?>');">상품 더보기</div> -->
              <div class="btn_more_wrap" <?=($psd_mode=='N')? "style='display:none;'" : "" ?>>
                    <button type="button" id="pre_goods_more-<?=$box_seq?>" onclick="conner_more('<?=$box_seq?>');">
                    <i class="material-symbols-outlined">add</i>
                    <!-- <span>상품 더보기</span> -->
...
<script>
  ...
  //       window.open("", pop_title);
    ...
    function font_chk(flag){
        if(flag=="N"){
            $("link[title='csstypes']").attr("href","/views/smart/bootstrap/css/style_A_n.css?v=<?=date("ymdHis")?>");
        }else{
            $("link[title='csstypes']").attr("href","/views/smart/bootstrap/css/style_A.css?v=<?=date("ymdHis")?>");
        }
