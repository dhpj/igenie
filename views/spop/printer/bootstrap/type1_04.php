...
<div id="print_div">
  ...
  <? if($ii % 4 == 1){
    $number++;?>
  <div class="pop_ntype04 <?=$style?>" id="screen<?=$number?>">
  <p class="goods_tit">
  ...
  <? if($ii % 4 == 0 || $ii == $goods_cnt){ ?>
    <!-- <p style="position: relative; display: block;width: 100%;height:300px !important; border:solid 1px #f00;">hih<br/>hhh<br/>hhh<br/></p> -->
    <?=$mylogotext?>
  </div>
  <? }?>
  <? } ?>
