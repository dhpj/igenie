        ...
        <div class="wl_lbox">
            ...
            ?>
                <div id="coupon_0" class="coupon">
                    ...
                    <div class="tit_box">
                        <ul>
                            <li id="li_type_0_1"<? if($data->pcd_type != "2"){ ?> class="tm_on"<? } ?>><a href="javascript:coupon_type(1, 0);"><span>TYPE 1.</span> 무료증정 쿠폰</a></li>
                            <li id="li_type_0_2"<? if($data->pcd_type == "2"){ ?> class="tm_on"<? } ?>><a href="javascript:coupon_type(2, 0);"><span>TYPE 2.</span> 가격할인 쿠폰</a></li>
                        </ul>
                    </div>
                                ...
                                <ul>
        							...
        							<li>
                                        ...
                                        <div class="barcode">
                                            ...
                                            <button type="button" class="btn_bar_ok" onclick="apply_barcode('type1', 0)"> 적용하기</button>
                        ...
                        <ul>
        					...
        					<li>
                                ...
                                <div class="barcode">
                                    ...
                                    <button type="button" class="btn_bar_ok" onclick="apply_barcode('type2', 0)"> 적용하기</button>
            ...
            ?>
                <div id="coupon_<?=$seq?>" class="coupon">
                    ...
                    <div class="tit_box">
                        <ul>
                            <li id="li_type_<?=$seq?>_1"<? if($a->pcdd_type != "2"){ ?> class="tm_on"<? } ?>><a href="javascript:coupon_type(1, <?=$seq?>);"><span>TYPE 1.</span> 무료증정 쿠폰</a></li>
                            <li id="li_type_<?=$seq?>_2"<? if($a->pcdd_type == "2"){ ?> class="tm_on"<? } ?>><a href="javascript:coupon_type(2, <?=$seq?>);"><span>TYPE 2.</span> 가격할인 쿠폰</a></li>
                        </ul>
                    </div>
                    <div class="wl_main_goods" id="coupon_type1_<?=$seq?>" style="display:<? if($a->pcdd_type == "2"){ ?>none<? } ?>"><?//무료증정 쿠폰 입력란?>
                        <dl class="dl_step1">
                            <dt>
                                <input type="hidden" id="pcd_imgpath_<?=$seq?>" value="<?=$a->pcdd_imgpath?>" style="width:600px;">
                                <div class="templet_img_in" onclick="showImg(<?=$seq?>)">
                                    <div id="div_preview">
                                        <img id="img_preview_<?=$seq?>" src="<?=$a->pcdd_imgpath?>">
                                    </div>
                                </div>
                            </dt>
                            <dd>
                                <ul>
                                    <li>
                                        <span class="tit">행사기간</span>
        		                        <input type="text" id="pcd_date_type1_<?=$seq?>" value="<?=$a->pcdd_date?>" onkeyup="chgData('pcd_date_type1_<?=$seq?>')" placeholder="2020.11.11. 단하루">
                                        <div class="counter">
                                            <span class="text">글자크기</span>
                                    ...
                                    <li>
                                        <span class="tit">쿠폰제목</span>
        				                <input type="text" id="pcd_title_type1_<?=$seq?>" value="<?=$a->pcdd_title?>" onkeyup="chgData('pcd_title_type1_<?=$seq?>')" placeholder="카톡친구 무료증정">
                                        <div class="counter">
                                            <span class="text">글자크기</span>
                                    ...
                                    <li>
                                        <span class="tit">상품정보</span>
        				                <input type="text" id="pcd_option1_type1_<?=$seq?>" value="<?=$a->pcdd_option1?>" onkeyup="chgData('pcd_option1_type1_<?=$seq?>')" placeholder="크리넥스 안심 키친타올">
                                        <div class="counter">
                                            <span class="text">글자크기</span>
                                    ...
                                    <li>
                                    <span class="tit">쿠폰옵션</span>
        			                    <input type="text" id="pcd_option2_type1_<?=$seq?>" value="<?=$a->pcdd_option2?>" onkeyup="chgData('pcd_option2_type1_<?=$seq?>')" placeholder="선착순 100개 한정수량">
                                        <div class="counter">
                                            <span class="text">글자크기</span>
        							...
        							<li>
                                        <span class="tit">바코드</span>
                                        <div class="barcode">
                                            <input type="hidden" id="apply_barcode_type1_<?=$seq?>" value="<?=$a->barcode_txt_length_flag != 0 ? "1" : "0"?>">
        									<select id="select_barcode_length_type1_<?=$seq?>" onchange="changeBarcodeSelect(this, 'type1', <?=$seq?>)">
                                                <option value="13" <?=$a->barcode_txt_length_flag == 13 ? "selected" : ""?>>13자리</option>
                                                <option value="8" <?=$a->barcode_txt_length_flag == 8 ? "selected" : ""?>>8자리</option>
                                            </select>
        									<input type="text" id="barcode_txt_type1_<?=$seq?>" value="<?=$a->barcode_txt?>" onkeyup="" maxlength=<?=$a->barcode_txt_length_flag == 8 ? 8 : 13?> style="width:120px !important;">
                                            <button type="button" class="btn_bar_ok" onclick="apply_barcode('type1', <?=$seq?>)"> 적용하기</button>
                    ...
                    <div class="wl_main_goods" id="coupon_type2_<?=$seq?>" style="display:<? if($a->pcdd_type != "2"){ ?>none<? } ?>"><?//가격할인 쿠폰 입력란?>
                        <ul>
                            <li>
                                <span class="tit">행사기간</span>
        		                <input type="text" id="pcd_date_type2_<?=$seq?>" value="<?=$a->pcdd_date?>" onkeyup="chgData('pcd_date_type2_<?=$seq?>')" placeholder="2020.11.11. 단하루">
                                <div class="counter">
                                    <span class="text">글자크기</span>
                            ...
                            <li>
                                <span class="tit">쿠폰제목</span>
        	                    <input type="text" id="pcd_title_type2_<?=$seq?>" value="<?=$a->pcdd_title?>" onkeyup="chgData('pcd_title_type2_<?=$seq?>')" placeholder=" 카톡친구 무료증정">
                                <div class="counter">
                                    <span class="text">글자크기</span>
                            ...
                            <li>
                                <span class="tit">쿠폰옵션1</span>
        		                <input type="text" id="pcd_option1_type2_<?=$seq?>" value="<?=$a->pcdd_option1?>" onkeyup="chgData('pcd_option1_type2_<?=$seq?>')" placeholder="3만원이상 구매시(1인1매)">
                                <div class="counter">
                                    <span class="text">글자크기</span>
                            ...
                            <li>
                                <span class="tit">할인금액</span>
                                <input type="text" id="pcd_price_type2_<?=$seq?>" value="<?=$a->pcdd_price?>" onkeyup="chgData('pcd_price_type2_<?=$seq?>')" placeholder="3,000원">
                                <div class="counter">
                                    <span class="text">글자크기</span>
                            ...
                            <li>
                                <span class="tit">쿠폰옵션2</span>
        	                    <input type="text" id="pcd_option2_type2_<?=$seq?>" value="<?=$a->pcdd_option2?>" onkeyup="chgData('pcd_option2_type2_<?=$seq?>')" placeholder="선착순 100명 현장할인" >
                                <div class="counter">
                                    <span class="text">글자크기</span>
        					...
        					<li>
                                <span class="tit">바코드</span>
                                <input type="hidden" id="apply_barcode_type2_<?=$seq?>" value="<?=$a->barcode_txt_length_flag != 0 ? "1" : "0"?>">
                                <div class="barcode">
        		                    <select id="select_barcode_length_type2_<?=$seq?>" onchange="changeBarcodeSelect(this, 'type2', <?=$seq?>)">
                                        <option value="13" <?=$a->barcode_txt_length_flag == 13 ? "selected" : ""?>>13자리</option>
                                        <option value="8" <?=$a->barcode_txt_length_flag == 8 ? "selected" : ""?>>8자리</option>
                                    </select>
        							<input type="text" id="barcode_txt_type2_<?=$seq?>" value="<?=$a->barcode_txt?>" onkeyup="" maxlength=<?=$a->barcode_txt_length_flag == 8 ? 8 : 13?> style="width:120px !important;">
                                    <button type="button" class="btn_bar_ok" onclick="apply_barcode('type2', <?=$seq?>)"> 적용하기</button>
            ...
            <div class="smart_coupon_preview">
                ...
                ?>
                    <div id="coupon_img_<?=$seq?>">
                        <div class="wl_r_preview" id="pre_coupon_type1_<?=$seq?>"  style="display:<? if($a->pcdd_type == "2"){ ?>none<? } ?>"><?//무료증정 쿠폰 미리보기?>
...
<script>
    ...
    $(document).on("click", function(e){
        if (e.target.tagName == "INPUT" && e.target.type == "text"){
            ...
            $('.smart_coupon_preview').animate( { scrollTop : 700 * index }, 500 );
        }
    });
    ...
    $(document).ready(function(){
        if ("<?=count($data)?>" > 0){
            ...
            foreach($data as $a){
            ?>
                $("#barcode_<?=$a->pcdd_type == 1 ? "type1" : "type2" ?>_<?=$seq?>").barcode(String($("#barcode_txt_<?=$a->pcdd_type == 1 ? "type1" : "type2" ?>_<?=$seq?>").val()), "ean<?=$a->barcode_txt_length_flag?>",{barWidth:2, barHeight:60, fontSize:20});
            <?
                $seq++;
            }
            ?>
    ...
    function addCoupon(){
        ...
        html = html + '        <ul>';
        html = html + '            <li id="li_type_' + seq + '_1" class="tm_on"><a href="javascript:coupon_type(1, ' + seq + ');"><span>TYPE 1.</span> 무료증정 쿠폰</a></li>';
        html = html + '            <li id="li_type_' + seq + '_2"><a href="javascript:coupon_type(2, ' + seq + ');"><span>TYPE 2.</span> 가격할인 쿠폰</a></li>';
        html = html + '        </ul>';
        html = html + '    </div>';
        ...
        html = html + '                           <button type="button" class="btn_bar_ok" onclick="apply_barcode(\'type1\', ' + seq + ')"> 적용하기</button>';
        ...
        html = html + '                   <button type="button" class="btn_bar_ok" onclick="apply_barcode(\'type2\', ' + seq + ')"> 적용하기</button>';
        ...
        html = html + '           </li>';
        html = html + '        </ul>';
        html = html + '        <button type="button" class="smart_coupon_del" onclick="delete_type(\'type2\', ' + seq + ')"><span class="material-icons">clear</span></button>';
        html = html + '    </div>';
        html = html + '</div>';
    ...
    function apply_barcode(coupon_type, seq){
        ...
        if (coupon_type == "type2") $("#pre_pcd_option2_type2_" + seq).addClass("exist_barcode");
    }
    ...
    function delete_barcode(coupon_type, seq){
        ...
        if (coupon_type == "type2") $("#pre_pcd_option2_type2_" + seq).removeClass("exist_barcode");
    }
	...
	//쿠폰 타입 선택
	function coupon_type(no, seq){
		$("#pcd_type_" + seq).val(no);
		if(no == 1){ //TYPE 1. 무료증정 쿠폰 입력란 오픈
			$('#li_type_' + seq + "_1").addClass('tm_on');
			$('#li_type_' + seq + "_2").removeClass('tm_on');
			area_over('coupon_type1_' + seq, 'coupon_type2_' + seq); //무료증정 입력란
			area_over('pre_coupon_type1_' + seq, 'pre_coupon_type2_' + seq); //무료증정 미리보기
		}else if(no == 2){ //TYPE 2. 가격할인 쿠폰 입력란 오픈
			$('#li_type_' + seq + "_2").addClass('tm_on');
			$('#li_type_' + seq + "_1").removeClass('tm_on');
			area_over('coupon_type2_' + seq, 'coupon_type1_' + seq); //가격할인 입력란
			area_over('pre_coupon_type2_' + seq, 'pre_coupon_type1_' + seq); //가격할인 미리보기
		}
	}
			...
			//alert("ext : "+ ext); return;
  			if($.inArray(ext, ['gif','png','jpg','jpeg']) == -1) {
				...
				if (input.files && input.files[0]){
					...
					reader.onload = function(e) {
                        var seq = $("#img_seq").val();
						$("#img_preview_" + seq).attr("src", e.target.result);
						$("#pre_div_preview_" + seq).css({"background":"url(" + e.target.result + ")"}); //미리보기 이미지 배경 URL
					}
					reader.readAsDataURL(input.files[0]);
					...
					$.ajax({
						...
						success: function (json) {
							...
							if(json.code == "0") { //성공
								jsFileRemove(input); //파일 초기화
								$("#img_preview_" + seq).attr("src", json.imgpath); //이미지 URL
								$("#pre_div_preview_" + seq).css({"background":"url(" + json.imgpath + ")"}); //미리보기 이미지 배경 URL
								$("#pcd_imgpath_" + seq).val(json.imgpath); //사진 경로
							}else{ //실패
								jsFileRemove(input); //파일 초기화
								$("#img_preview_" + seq).attr("src", ""); //이미지 URL
								$("#pre_div_preview_" + seq).css({"background":"url(<?=$sample_img?>)"}); //미리보기 이미지 배경 URL
								$("#pcd_imgpath_" + seq).val(""); //사진 경로
								alert(json.msg);
								return;
							}
						}
	...
	function set_img_library(imgpath){
		...
		if(imgpath != ""){
            var seq = $("#img_seq").val();
			$("#img_preview_" + seq).attr("src", imgpath); //이미지 URL
			$("#pre_div_preview_" + seq).css({"background":"url(" + imgpath + ")"}); //미리보기 이미지 배경 URL
			$("#pcd_imgpath_" + seq).val(imgpath); //사진 경로
			modal2.style.display = "none"; //상품 이미지 추가 모달창 닫기
	...
	function saved(flag){
        ...
        for (var i = 0; i < coupon_seq; i++){
            if ($("#coupon_" + i).length > 0){
                var pcd_type = $("#pcd_type_" + i).val();
                var type = $("#pcd_type_" + i).val() == "1" ? "type1" : "type2";
                if(pcd_type == "1"){ //무료증정
                    pcd_imgpath = $("#pcd_imgpath_" + i).val().trim(); //이미지경로
                    if(pcd_imgpath == ""){
                        alert("쿠폰 이미지를 추가하세요.");
                        showImg(i);
                        return false;
                ...
                if($("#pcd_date_" + type + "_" + i).val().trim() == ""){
                    alert("행사기간을 입력하세요.");
                    $("#pcd_date_" + type + "_" + i).focus();
                    return false;
                }
                if($("#pcd_title_" + type + "_" + i).val().trim() == ""){
                    alert("쿠폰제목을 입력하세요.");
                    $("#pcd_title_" + type + "_" + i).focus();
                    return false;
                }
                if(pcd_type == "1"){ //무료증정
                    if($("#pcd_option1_" + type + "_" + i).val().trim() == ""){
                        alert("상품정보를 입력하세요.");
                        $("#pcd_option1_" + type + "_" + i).focus();
                        return false;
                    }
                    if($("#pcd_option2_" + type + "_" + i).val().trim() == ""){
                        alert("쿠폰옵션을 입력하세요.");
                        $("#pcd_option2_" + type + "_" + i).focus();
                        return false;
                    }
                    ...
                    if($("#pcd_price_" + type + "_" + i).val().trim() == ""){
                        alert("할인금액을 입력하세요.");
                        $("#pcd_price_" + type + "_" + i).focus();
                        return false;
                    }
                    if($("#pcd_option2_" + type + "_" + i).val().trim() == ""){
                        alert("쿠폰옵션2를 입력하세요.");
        ...
        for (var i = 0; i < coupon_seq; i++){
            if ($("#coupon_" + i).length > 0){
                ...
                var dataAraay = [pcdd_type, pcdd_date, pcdd_title, pcdd_option1, pcdd_option2, pcdd_price, pcdd_date_size, pcdd_title_size, pcdd_option1_size, pcdd_option2_size, pcdd_price_size, pcdd_imgpath, pcdd_barcode_length_flag, pcdd_barcode_txt, pcdd_barcode_img_path];
		...
		var t = target[0];
		html2canvas(t, {scale:1, scrollX: 0, scrollY:0}).then(function(canvas) {
				...
				success: function (json) {
					...
					if(json.code == "0") { //성공
						...
						if(json.flag == "lms"){ //문자메시지 발송
							...
							location.href = "/dhnbiz/sender/send/talk_adv_v3?pcd_code="+ json.pcd_code +"&pcd_type="+ pcd_type; //알림톡 발송 페이지
						}else{
