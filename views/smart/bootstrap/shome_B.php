...
?>
  ...
  <div class="smart_header st_nh">
    <span class="shome_nh"><img src="http://14.43.241.107/uploads/shome/shome_nh.jpg" alt="<?=config_item('site_name')?>"></span>
  ...
  <div class="smart_menu_s" style="display:none;">
	...
	<div class="smart_box shome_nh">

  <div class="mart_homemenu"style="margin-top:40px;">
      <ul>
  ...
  <div id="menu01" class="shome_content">
      ...
      <div class="nh_btn smart_btn<?=$cnt?> shiny-btn1">
        <? if(!empty($link->psd_url)){ ?>
        <a class="btn_smartevent wow animate__animated animate__pulse" href="<?="/smart/view/".$link->psd_code."?home=".$key?>"><p><img src="/images/shome_icon_event.png" /></p>행사보기</a>
        <? } ?>
        <? if(!empty($link->html)&&$link->html != '<p><br></p>' && $link->html != '<p><span style="font-size: 18px;">﻿</span><br></p>'){ ?>
        <a class="btn_smarteditor wow animate__animated animate__pulse" href="<?='/at/'.$link->short_url."?home=".$key?>"><p><img src="/images/shome_icon_mart.png" /></p>전단보기</a>
        <? } ?>
        <? if(!empty($link->pcd_url)){ ?>
        <a class="btn_smartcoupon wow animate__animated animate__pulse" href="<?="/smart/coupon/".$link->pcd_code."?home=".$key?>"><p><img src="/images/shome_icon_coupon.png" /></p>쿠폰보기</a>
        <? } ?>
        <? if(!empty($link->order_url)){ ?>
        <a class="btn_smartcoupon wow animate__animated animate__pulse" href="<?=$link->order_url?>"><p><img src="/images/shome_icon_car.png" /></p>주문하기</a>
        <? } ?>
      </div>
...
<div id="menu02" class="shome_content">
