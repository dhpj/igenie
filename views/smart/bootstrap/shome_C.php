...
?>
  <div class="fix_bot_btn mart_btn smart_btn<?=$cnt?>">
    <? if(!empty($link->psd_url)){ ?>
    <a class="btn_smartevent" href="<?="/smart/view/".$link->psd_code."?home=".$key?>"><img src="/images/shome_icon_event_w.png" /> <span>행사보기</span></a>
    <? } ?>
     <? if((!empty($link->html)&&!empty($link->url)||$link->mst_id==0&&!empty($link->html))&&$link->html != '<p><br></p>' && $link->html != '<p><span style="font-size: 18px;">﻿</span><br></p>'){ ?>
    <a class="btn_smarteditor" href="<?='/at/'.$link->short_url."?home=".$key?>"><img src="/images/shome_icon_mart_w.png" /> <span>전단보기</span></a>
    <? } ?>
    <? if(!empty($link->pcd_url)){ ?>
    <a class="btn_smartcoupon" href="<?="/smart/coupon/".$link->pcd_code."?home=".$key?>"><img src="/images/shome_icon_coupon_w.png" /> <span>쿠폰보기</span></a>
    <? } ?>
    <? if(!empty($link->order_url)){ ?>
    <a class="btn_smartcoupon" href="<?=$link->order_url?>"><img src="/images/shome_icon_car_w.png" /> <span>주문하기</span></a>
    <? } ?>
  </div>

  <script src="https://developers.kakao.com/sdk/js/kakao.min.js"></script>
  <div class="smart_header st_mart">
  ...
  <div class="smart_menu_s" style="display:none;">
	...
	<div class="smart_box shome_mart">
  <!-- <div class="smart_top" style="margin-top:0; background: url(<? if($shop->mem_shop_img != ""){ ?><?=config_item('igenie_path').$shop->mem_shop_img?><? }else{ ?>/dhn/images/mi_pick.jpg<? } ?>)no-repeat; background-size: cover;">
  ...
  <div id="menu01" class="shome_content">
      ...
      <div class="smart_bot" style="margin-bottom:80px;">
    	  <ul>
            <!-- <li>
    		...
    		<li>
    		 <span class="material-icons">favorite</span> 운영시간 : <?=$shop->mem_shop_time?>
    		</li>
    		<li>
    		  <span class="material-icons">favorite</span> 휴무일 : <?=$shop->mem_shop_holiday?>
    		</li>
    		<li>
    		  <span class="material-icons">favorite</span> 전화번호 : <a class="font_num" href="tel:<?=$shop->mem_shop_phone?>"><?=$shop->mem_shop_phone?></a>
    		</li>
    		<li>
    		  <span class="material-icons">favorite</span> 주소 : <?=$shop->mem_shop_addr?>
    		</li>
    	  </ul>
      </div><!--//smart_bot-->
</div>

<div id="menu02" class="shome_content" style="margin-bottom:80px;">
...
<div id="menu04" class="shome_content">
    <div class="smart_map" id="smart_map" style="width:100%; height:250px; margin-bottom:80px;">
    </div><!-- 카카오맵 - 지도 -->
</div>
