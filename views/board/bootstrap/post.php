...
<div id="mArticle">
					<div class="form_section">
						<div class="inner_tit">
							<p class="fr" style="font-size: 16px;line-height: 1.8;"><?php echo element('display_datetime', element('post', $view)); ?></p>
							<h3>
...
<div class="board">
    ...
    <!--h3><i class="icon-home"></i><?php echo html_escape(element('board_name', element('board', $view))); ?></h3-->
	<div class="wrap">
		<!--h4>
			<?php if (element('category', element('post', $view))) { ?>[<?php echo html_escape(element('bca_value', element('category', element('post', $view)))); ?>] <?php } ?>
      <?php echo html_escape(element('post_title', element('post', $view))); ?>
	...
	<div class="border_button mt20">
		<button onClick="location.href='<?php echo element('list_url', $view); ?>'" class="btn sm fl" style="margin-right: 10px;">목록</button>
...
<?php if (element('write_url', $view)) { ?>
			<button onClick="location.href='<?php echo element('write_url', $view); ?>'" class="btn sm yellow fr">글쓰기</button>
<?php } ?>
	</div>
<!--</div>-->
