   ...
   <!--h3><?php echo html_escape(element('board_name', element('board', $view))); ?> 글쓰기</h3-->
    ...
    ?>
        ...
        <div class="form-horizontal box-table">
            <?php if (element('is_post_name', element('post', $view))) { ?>
                ...
                <?php if ($this->member->is_member() === false) { ?>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="password" class="form-control px150" name="post_password" id="post_password" style="width:200px;display:inline-block !important;" /> <span style="padding:5px 0 0 5px;display:inline-block;">※ 특수문자 표함 8자리 이상 입력하세요.</span>
                        </div>
                    </div>
                <?php } ?>
                <div class="form-group row">
            ...
            <?php } ?>
            <div class="border_button tc">
                <button type="button" class="btn md btn-history-back">취소</button>
                <button type="submit" class="btn md">작성완료</button>
            </div>
        </div>
    <?php echo form_close(); ?>
	</div>
