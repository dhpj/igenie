						...
						<div class="white_box">
							<div class="board">
							    ...
							    ?>
							        ...
							        <table>
								        <colgroup>
											<?php if (element('is_admin', $view)) { ?><col width="50px"><?php } ?>
											<col width="50px">
											<col width="*">
											<col width="100px">
											<col width="100px">
							            ...
							            <thead>
							                <tr>
							                    <?php if (element('is_admin', $view)) { ?><th><input class="uniform" onclick="if (this.checked) all_boardlist_checked(true); else all_boardlist_checked(false);" type="checkbox" /></th><?php } ?>
							                    <th>번호</th>
							                    <th>제목</th>
							                    <th>글쓴이</th>
							                    <th>날짜</th>
							            ...
							            ?>
							                <tr>
							                    <?php if (element('is_admin', $view)) { ?><td scope="row"><input class="uniform" type="checkbox" name="chk_post_id[]" value="<?php echo element('post_id', $result); ?>" /></td><?php } ?>
							                    <td><span class="label_red">중요</span></td>
							                    <td class="tl">
							    ...
							    <div class="border_button">
							        <div class="pull-left mr10">
							            <!-- <a href="<?php echo element('list_url', element('list', $view)); ?>" class="btn_st1">목록</a> -->
							        ...
							        <?php if (element('is_admin', $view)) { ?>
							            <div class="pull-left">
							                <!--<button type="button" class="btn_st1"><i class="fa fa-cog big-fa"></i> 관리</button>-->
							        ...
							        <?php if (element('write_url', element('list', $view))) { ?>
							            <div class="pull-right">
							                <a href="<?php echo element('write_url', element('list', $view)); ?>" class="btn_st1">글쓰기</a>
							            </div>
							        <?php } ?>
							    </div>
							    ...
							    <div style="text-align: center">
							            <div class="searchbox">
							                <form class="navbar-form" style="padding: 0; margin: 0;" action="<?php echo board_url(element('brd_key', element('board', element('list', $view)))); ?>" onSubmit="return postSearch(this);">
							                    ...
							                    <div class="form-group">
							                        ...
							                        <button class="btn md" type="submit"><i class="fa fa-search"></i></button>
							                    </div>
							                </form>
							            </div>

							            <div class="searchbuttonbox">
							                <button class="btn md" type="button" onClick="toggleSearchbox();"><i class="fa fa-search"></i></button>
							            </div>
							            ...
							            <?php } ?>
											...
											<div class="page_cen"><?php echo element('paging', element('list', $view)); ?></div>
							</div>
						</div>
					</div>
</div>
