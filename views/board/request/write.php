    ...
    ?>
        ...
        <div class="form-horizontal box-table">
               ...
               <div class="form-group col-group">
                  ...
                  <div class="col-sm-8 pd7"><input type="text" id="ct_manager" name="ct_manager" class="form-control input" value="<?=$view['extra_content'][0]['value']?>" required/></div>
               </div>
				</div>
				<div class="row row-group">
               <div class="form-group col-group">
						<label for="post_password" class="col-sm-4 control-label">비밀번호</label>
						<div class="col-sm-8 pd7">
							<input type="password" class="form-control px150" name="post_password" id="post_password" style="width:200px;display:inline-block !important;" /> <span style="padding:5px 0 0 5px;display:inline-block;">※ 특수문자 포함 8자리 이상</span>
						</div>
					</div>
					<div class="form-group col-group">
				...
				<div class="row row-group">
					<div class="form-group col-group">
						...
						<div class="col-sm-8 pd7"><input type="text" id="ct_hp" name="ct_hp" class="form-control input validphone" value="<?=$view['extra_content'][1]['value']?>" required /></div>
					</div>
					<div class="form-group col-group">
						<label class="col-sm-4 control-label" for="ct_tel">전화번호</label>
						<div class="col-sm-8 pd7"><input type="text" id="ct_tel" name="ct_tel" class="form-control input validphone" value="<?=$view['extra_content'][2]['value']?>" required /></div>
					</div>
				</div>
				<div class="row row-group">
					<div class="form-group col-group">
						<label class="col-sm-4 control-label" for="ct_kakao_name">카카오플러스 친구이름</label>
						<div class="col-sm-8 pd7"><input type="text" id="ct_kakao_name" name="ct_kakao_name" class="form-control input" value="<?=$view['extra_content'][3]['value']?>" /></div>
					</div>
					<div class="form-group col-group">
						<label class="col-sm-4 control-label" for="ct_kakao_id">카카오 검색용 아이디</label>
						<div class="col-sm-8 pd7"><input type="text" id="ct_kakao_id" name="ct_kakao_id" class="form-control input" value="<?=$view['extra_content'][4]['value']?>" /></div>
					</div>
				</div>
				<div class="row row-group">
					<div class="form-group col-group">
						<label class="col-sm-4 control-label" for="ct_kakao_home">카카오 홈 URL</label>
						<div class="col-sm-8 pd7"><input type="text" id="ct_kakao_home" name="ct_kakao_home" class="form-control input" value="<?=$view['extra_content'][5]['value']?>" /></div>
					</div>
				...
				<div class="row row-group">
					<div class="form-group col-group">
						...
						<div class="col-sm-8 pd7"><input type="text" id="ct_send_qty" name="ct_send_qty" class="form-control input" value="<?=$view['extra_content'][6]['value']?>" /></div>
					</div>
					<div class="form-group col-group">
						<label class="col-sm-4 control-label" for="ct_hosting">호스팅종류</label>
						<div class="col-sm-8 pd7"><div class="input-group">
							<select name="ct_hosting" class="form-control input" >
								<option value="" >선택하세요</option>
								<option value="웹호스팅" <?=($view['extra_content'][7]['value']=="웹호스팅") ? "selected" : ""?> >웹호스팅</option>
							</select>
						</div></div>
					</div>
				</div>
            ...
            <div class="form-group row">
                <label for="post_title" class="col-sm-2 control-label">상담 제목</label>
            ...
            <?php
				/* 사용자 정의 필드 표시부분 */
            if (0>1 && element('extra_content', $view)) {
...
function submitContents(f) {
	 try { oEditors.getById["post_content"].exec("UPDATE_CONTENTS_FIELD", []); }catch(e){}
    if ($('#char_count')) {
...
<?php if ($this->member->is_member() === false) { ?>
            , post_password: {required :true, minlength:8, maxlength:100}
<?php } ?>
<?php if ( element('is_use_captcha', element('board', $view)) ) { ?>
<?php if ($this->cbconfig->item('use_recaptcha')) { ?>
