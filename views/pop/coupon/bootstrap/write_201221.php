	...
	function saved(flag){
		...
		$.ajax({
			...
			data: {
				...
				, "flag" : flag //구분
				, "data_id" : data_id //일련번호
				, "pcd_type" : pcd_type //쿠폰타입(1.무료증정, 2.가격할인)
				, "pcd_date" : pcd_date //행사기간
				, "pcd_title" : pcd_title //쿠폰제목
				, "pcd_option1" : pcd_option1 //상품정보/쿠폰옵션1
				, "pcd_option2" : pcd_option2 //쿠폰옵션/쿠폰옵션2
				, "pcd_price" : pcd_price //할인금액
				, "pcd_imgpath" : pcd_imgpath //이미지경로
				, "pcd_date_size" : pcd_date_size //행사기간 폰트크기
				, "pcd_title_size" : pcd_title_size //쿠폰제목 폰트크기
				, "pcd_option1_size" : pcd_option1_size //상품정보/쿠폰옵션1 폰트크기
				, "pcd_option2_size" : pcd_option2_size //쿠폰옵션/쿠폰옵션2 폰트크기
				, "pcd_price_size" : pcd_price_size //할인금액 폰트크기
			},
			success: function (json) {
