...
<style>
@media only print{
	.genie_container .contents_wrap{background: url(/dhn/images/leaflets/pop/pop_bg09.jpg) no-repeat top left; background-size:auto 100%;}
	.pop_ntype09_bg{display: none;}
}
</style>
<div class="pop_ntype09" id="screen">
  <div class="pop_ntype09_bg">
    <img src="/dhn/images/leaflets/pop/pop_bg09.jpg" alt="" />
  </div>
