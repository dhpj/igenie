...
<div class="mypage">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="#">회원 비밀번호 변경</a></li>-
		  <li><a href="<?php echo site_url('membermodify/memberleave'); ?>" title="탈퇴하기">탈퇴하기</a></li>
    </ul>
-->
    <div class="crumbs">
        <ul id="breadcrumbs" class="breadcrumb">
            <li><i class="icon-home"></i><a href="/biz/myinfo/info">마이페이지</a></li>
            <li><a href="#">회원 비밀번호 변경</a></li>
        </ul>
    </div>
		<div class="snb_nav">
				<ul class="clear">
						<li class="active"><a href="/biz/myinfo/info">회원 비밀번호 변경</a></li>
				</ul>
		</div>
    <div class="form-horizontal content_wrap mt50">
        <?php
