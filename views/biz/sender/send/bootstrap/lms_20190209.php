    ...
    <div class="content_wrap">
	 ...
	 <table class="table table-bordered table-highlight-head table-checkable mt10"   id="friendtalk_table">
        ...
        <tbody>
            ...
            <div class="widget box mt20" id="file_upload_div">
            ...
            <div class="widget box mt10">
                ...
                <div class="widget-header" id="custom_load_div">
                    <h4>수신 번호</h4>
            ...
            <div class="preview_wrap">
                ...
                <div class="abs_box">
                    ...
                    <div class="mt20 align-center">
                        ...
                        <button class="btn" type="button" id="open_msg_list_" onclick="open_lmsmsg_list();">불러오기</button>
