        ...
        <div class="col-xs-4">
            <div class="preview_wrap">
                ...
                <div class="abs_box">
                    ...
                    <div class="mt20 align-center">
                        <button class="btn" type="button" id="msg_save_temp" onclick="msg_save('TEMP');">임시저장하기</button>
                        <button class="btn" type="button" id="msg_save_" onclick="msg_save('SAVE');">저장하기</button>
                        <button class="btn" type="button" id="open_msg_list_" onclick="open_msg_lms_list();">불러오기</button>
	...
	function select_lms(check){
		...
		if (sms_sender == "None" || sms_sender.replace(/ /gi, "") == "") {
			...
			if (check.checked  || (check.checked == undefined  && $("#lms_select").is(":checked"))) {
				...
				temp_cont = temp_cont.replace("수신거부=홈>친구차단", "수신거부 : 홈>친구차단");	//2019.02.08. 이수환 차후에 삭제
    			if (temp_cont.indexOf("수신거부 : 홈>친구차단") < 0) {
        			if (temp_contRow[temp_contRow.length - 1].indexOf("http://") >= 0) {
        				temp_cont += "\n수신거부 : 홈>친구차단";
        			} else { 
        				temp_cont += "\n\n수신거부 : 홈>친구차단";
        			}
...
<?}?>
                ...
                cont = cont.replace(/[\u2100-\u2120\u2123-\u214F\u2190-\u21FF\u0080-\u008F\uFE50-\uFE6F\u2460-\u24FF\u2300-\u259F\u25A2\u25A4-\u25A5\u25A7-\u25B1\u25B4-\u25B5\u25B8-\u25BB\u25BE-\u25BF\u25C2-\u25C5\u25C8-\u25CA\u25CC-\u25CD\u25D2-\u2604\u2607-\u260D\u260F-\u261D\u261F-\u263F\u2641\u2643-\u2660\u2662\u2664\u2666\u2668-\u2669\u266B\u266D-\u303F\u3100-\u32FF\u2150-\u2189\u2200-\u2298\u229A-\u22FF\u0080-\u00FF\u2000-\u203A\u203C-\u206F\uFF00-\uFF02\uFF04-\uFF05\uFF07-\uFF1F\uFF21-\uFFEF\u3130-\u318F\u0000-\u0009\u3300-\u33FF\u0400-\u04FF\u2070-\u209C]/gi, ""); 
