        ...
        <div class="modal-dialog" id="modalCheck">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div>
                        <button type="button" class="btn md btn-default" data-dismiss="modal" onclick="cancelClick();">취소</button>
                        <button type="button" class="btn md btn-primary all" onclick="all_move();">확인</button>
                    </div>
                </div>
            </div>
        </div>
...
?>
	...
	function set_price()
	{
    	...
    	case 'SMART' :
    		if($('#smslms_kind').val() == 'SMS') {
    			send_price = <? if($this->Biz_model->price_smt_sms > 0) { echo $this->Biz_model->price_smt_sms ; } else { echo 0; } ?>;
    		} else if($('#smslms_kind').val() == 'LMS') {
    			if(userfile != "") {
    				send_price = <? if($this->Biz_model->price_smt_mms > 0) { echo $this->Biz_model->price_smt_mms ; } else { echo 0; } ?>;
    				$('#smslms_kind_r').val("MMS");
    			} else {
    				send_price = <? if($this->Biz_model->price_smt > 0) { echo $this->Biz_model->price_smt ; } else { echo 0; } ?>;
    			}
    		} else if($('#smslms_kind').val() == 'MMS') {
    			send_price = <? if($this->Biz_model->price_smt_mms > 0) { echo $this->Biz_model->price_smt_mms ; } else { echo 0; } ?>;
    		}
