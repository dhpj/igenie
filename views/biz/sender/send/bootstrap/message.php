...
<!-- 타이틀 영역 -->
				<div class="tit_wrap">
      			...
      			<a href="/uploads/kakao_guide_202005_v1_o2o.pdf" target="_blank"><i class="material-icons">zoom_in</i>카카오채널 생성가이드</a> <a href="/uploads/kakao_guide_202005_v1_o2o.pdf" target="_blank"><i class="material-icons">zoom_in</i>카카오채널 활용가이드</a> <a href="/uploads/o2o_guide202005_v1.pdf" target="_blank"><i class="material-icons">zoom_in</i>발송가이드</a>
      		</div>
				</div>
<!-- 타이틀 영역 END -->
				<div id="mArticle">
					<div class="form_section">
						<div class="inner_content">
							<div class="msg_inner">
								...
								<div class="msg_main">
									<div class="msg_select friendtalk" onclick="location.href='/biz/sender/send/friend'">
										<div class="type_info">
										<h3>친구톡</h3>
									...
									<div class="msg_select friendtalk_w" onclick="location.href='/biz/sender/send/friend_wide'">
										<div class="type_info">
										<h3>친구톡(와이드 이미지형)</h3>
										<p>- 텍스트 최대 76자까지 가능
								...
								<div class="msg_main">
									<div class="msg_select alimtalk" onclick="location.href='/biz/sender/send/talk'">
										<div class="type_info">
										<h3>알림톡 발송</h3>
									...
									<div class="msg_select sms" onclick="">
									<? } else { ?>
								...
								<div class="msg_main">
									<div class="msg_select msg_coupon" onclick="location.href='/biz/sender/send/coupon'">
										<h3>타겟고객 쿠폰 발송</h3>
										<p>쿠폰을 알림톡으로 발송할 수 있습니다.</p>
										<!--button class="btn btn_msg_select">쿠폰 작성</button-->
									</div>
									<div class="msg_select collect_select" onclick="location.href='/biz/sender/send/talk/nft_talk'">
										<h3>친구모으기</h3>
										<p>내 고객중 아직 친구등록이 안된 고객에게만<br>자동으로 알림톡을 보내 친구등록을 유도합니다.</p>
										<!--button class="btn btn_msg_select">친구모으기 바로가기</button-->
									</div>
									<div class="msg_select delivery_msg" onclick="location.href='/biz/sender/send/talk_m'">
										<h3>모바일 배송알림톡</h3>
