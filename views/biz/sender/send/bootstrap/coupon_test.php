...
<div id="mArticle">
	...
	<div class="btn_send_cen">
		...
		<button class="btn_send"  onclick="all_send();">타겟쿠폰발송</button>
	</div>
</div><!-- mArticle END -->
...
<div class="modal select fade" id="sendbox_select" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" id="modal">
		<div class="modal-content">
			...
			<div class="modal_title">내 문자함 (알림톡)</div>
			<div class="modal-body">
				...
				<div class="modal_bottom">
					<button type="button" class="btn" id="code" name="code" onclick="select_sendbox();">확인</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal-dialog modal-lg" id="modal" data-keyboard="false" data-backdrop="static">
		<div class="modal-content">
			...
			<div class="modal_body">
				<div class="widget-content" id="template_list"></div>
				<div class="modal_bottom">
					<button type="button" class="btn md yellow" id="code" name="code" onclick="select_template();">확인</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal-dialog modal-lg" id="modalCheck">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="content"></div>
				<div>
						<button type="button" class="btn temp">확인</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal-dialog modal-lg" id="modalCheck">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div>
					<p align="right">
						<button type="button" class="btn up">확인</button>
					</p>
				</div>
			</div>
		</div>
	...
	<div class="modal-dialog modal-lg" id="modalCheck">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div>
						<button type="button" class="btn down">확인</button>
				</div>
			</div>
		</div>
	</div>
...
<div class="modal select fade" id="myModalLoadCustomers" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden>
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<i class="material-icons modal_close" data-dismiss="modal">close</i>
			<div class="modal_title">고객정보 가져오기</div>
			<div class="modal-body">
				<div class="mb20 mt10">
...
<?/*----------------------------------*
	...
	*----------------------------------*/?>
	...
	function all_send() {
		...
		if (emptyVar !== true) {
			alert("쿠폰내용 "+ (Number(emptyVar)+1) +"번째 변수를 입력해주세요.");
		...
		//} else if ($("#switch_select").is(":checked") && $("input[name=checkOne]:checked").length > 0) {	// 고객 DB에서 그룹 선택
			...
			$.ajax({
				...
				data: {"<?=$this->security->get_csrf_token_name()?>":"<?=$this->security->get_csrf_hash()?>",
					...
					"mst_type1" : mst_type1, "mst_type2" : mst_type2, "couponid":couponid	// 2019.01.31 이수환 추가 ; mst_type1(1차 문자 = 카카오 관련 문자), mst_type2(2차 문자 = 카카오톡 외의 문자)
				},
				beforeSend: function () {
					$('#overlay').fadeIn();
				},
