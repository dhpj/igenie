<html>
   <head>
      ...
      <script type="text/javascript">
         ...
         $(function(){ 
             generateBarcode(1,"2928911000118");
         });
   ...
   <body style="position: absolute;top: 0;left: 0;left: 50%;margin-left:-139px;background-color: rgb(199,224,228);">
      ...
      <div id="contents" style="width:278px">
         <div id="pre_title" style="padding-bottom: 10px;">
            ...
            <li style="padding-bottom: 10px;display: block;padding: 0 10px;color: rgb(46,172,188);font-size: 12px;">사용기간 : 2018-10-31까지</li>
         </div>
         <span id="txt_btn">직원확인 완료</span>
         <pre style="margin:10px">축하합니다. 당첨입니다.</pre>
      </div>
   </body>
</html> 