    ...
    <div class="crumbs">
        <ul id="breadcrumbs" class="breadcrumb">
            <li><i class="icon-home"></i><a href="/biz/sender/send/talk">발신</a></li>
            <li><a href="#">발신</a></li>
    ...
    <div class="snb_nav">
        <ul class="clear">
            <li class="active"><a href="/biz/sender/send/talk">알림톡</a></li>
...
<script type="text/javascript">
    ...
    function download() {
        if ($("#templi_code").val() == null) {
            ...
            document.body.appendChild(form);
            form.setAttribute("method", "post");
            form.setAttribute("action", "/biz/sender/at_download");
 ...
 //mms로 변경됐을때,,조건문 걸기 TODO
    ...
    function insert_kakao_link(check){
        ...
        $.ajax({
            url: "/biz/sender/friend/short_url",
            type: "POST",
