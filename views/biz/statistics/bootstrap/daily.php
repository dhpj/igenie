...
<div id="mArticle">
        ...
        <ul>
            ...
            <li class="active"><a href="javascript:statistics_pages_load('/biz/statistics/daily')">일일통계</a></li>
	...
	<div class="white_box">
		<div class="inner_content">
            <div class="search_box white_box">
            	...
            	<input type="text" class="form-control input-width-medium inline datepicker" name="endDate" id="endDate" value="<?=$param['endDate']?>" readonly="readonly" style="cursor: pointer;background-color: white">
              <div class="block_line">
            	...
            	<div class="fr">총 <? echo $list_cnt;?>건 조회</div>
							</div>
                <!-- /form-->
            </div>
		 	<div class="table_list white_box">
                <table id="data_grid">
                 	<colgroup>
                        ...
                        <!--<col width="70px"><?//발송성공 > 친구톡 와이드 이미지?>
						<? if($this->member->item('mem_level')>=50) { ?>
    ...
    <script type="text/javascript">
    	...
    	function search() {
    		...
    		form.setAttribute("action", "/biz/statistics/daily");
...
// 							$salesperson = $r->ds_name." ".$r->ds_position."(".$r->dbo_name.")"
				  ...
				  ?>
					  sum = {
							...
							"get_title"              	        : '<?=($param['startDate']." ~ ".$param['endDate'])?>',
