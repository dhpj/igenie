...
<div id="mArticle">
        ...
        <ul>
            ...
            <li class="active"><a href="/biz/statistics/monthly">월별통계</a></li>
        </ul>
    	</div>
	<div class="white_box">
		 	...
		 	<div class="table_list white_box">
                <table id="data_grid">
                    ...
                    <tr>
                        ...
                        <? if($this->member->item('mem_level')>=50) { ?>
                        <th class="text-center" colspan="14">성공 상세</th>
                        <? } else {?>
                        <th class="text-center" colspan="13">성공 상세</th>
                        <? } ?>
                        <th class="text-center" colspan="13">실패 상세</th>
                    </tr>
                    <tr>
                        ...
                        <?$sum_req=0;
        				  ...
        				  foreach($list as $r) {
                            ...
                            <tr>
                                ...
                                <? if($this->member->item('mem_level')>=50) { ?>
                                <td class="text-right" style="padding:8px 1px 8px 0px;" id='8_1'><?=number_format($r->mst_grs - $r->mst_grs_biz_qty)?></td>
                                ...
                                <td class="text-right" style="padding:8px 1px 8px 0px;" id='12'><?=number_format($r->mst_nas)?></td>
                                ...
                                <td class="text-right" style="padding:8px 1px 8px 0px;" id='15'><?=number_format($r->mst_smt)?></td>
                                ...
                                <td class="text-right" style="padding:8px 1px 8px 0px;" id='21'><?=number_format($r->qty_grs)?></td>
                                ...
                                <td class="text-right" style="padding:8px 1px 8px 0px;" id='24'><?=number_format($r->qty_nas)?></td>
                                ...
                                <td class="text-right" style="padding:8px 1px 8px 0px;" id='27'><?=number_format($r->qty_smt)?></td>
