		...
		<div class="inner_content">
	        <div class="search_box white_box">
				...
				<form action="/biz/statistics/month" method="post" id="mainForm">
    	            ...
    	            <input type="text" class="form-control input-width-small inline datepicker" name="startDate" id="startDate" readonly="readonly" style="cursor: pointer;background-color: white" value="<?=$param['startDate']?>"> ~
    	            <input type="text" class="form-control input-width-small inline datepicker" name="endDate" id="endDate" readonly="readonly" style="cursor: pointer;background-color: white" value="<?=$param['endDate']?>">
			...
			<div class="table_list white_box">
                <table>
                    ...
                    <tr>
                        ...
                        <th class="text-center" colspan="<? if($this->member->item('mem_level')>=50) { ?>7<? } else {?>7<? } ?>">발송성공</th>
                        ...
                        <?$sum_req=0;
                          ...
                          $succ = 0;
                            ...
                            <tr>
								...
								-->
                                <td class="text-right" style="padding:8px 1px 8px 0px;"><?=number_format($r->mst_smt)?></td><?//발송성공 > WEB(C)?>
								...
								-->
                                <td class="text-right" style="padding:8px 1px 8px 0px;"><?=number_format($r->qty_smt)?></td><?//발송실패 > WEB(C)?>
