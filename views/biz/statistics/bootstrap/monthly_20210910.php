		...
		<div class="inner_content">
            <div class="search_box white_box">
                ...
                <form action="/biz/statistics/monthly" method="post" id="mainForm">
                	...
                	<input type="text" class="form-control input-width-medium inline datepicker" name="startDate" id="startDate" value="<?=$param['startDate']?>" onChange="submit_handler();" readonly="readonly" style="cursor: pointer;background-color: white">
                        ...
                        <?$sum_req=0;
        				  ...
        				  foreach($list as $r) {
                            ...
                            <tr>
                                ...
                                <td class="text-right" style="padding:8px 1px 8px 0px;" id='5'><?=number_format($r->mst_ai)?></td>
                                ...
                                <td class="text-right" style="padding:8px 1px 8px 0px;" id='18'><?=number_format($r->err_ai)?></td>
