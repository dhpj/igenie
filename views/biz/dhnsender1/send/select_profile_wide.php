<?if($rs->spf_key) {?>
									...
									<div class="mobile_preview">
										...
										<div class="preview_msg_wrap">
											<div class="preview_msg_window">
												...
												<div class="preview_box_msg wide" id="text">
								...
								<div class="input_content_wrap">
									...
									<div class="input_content">
										...
										<button class="btn md" onclick="imageSelect()" id="img_select"><i class="icon-folder-open"></i>와이드 이미지 선택</button>
								...
								<div class="input_content_wrap">
									...
									<div class="input_content">
										<div class="msg_box">
											...
											<span class="txt_byte" id="templi_length"><span id="type_num">0</span>/76자</span>
