<?if($rs->spf_key) {?>
								...
								<div class="input_content_wrap">
									...
									<div class="input_content">
										<button class="btn md fr" style="margin-left: -1px;" onclick="imageSelect()" id="img_select"><i class="icon-folder-open"></i>이미지 선택</button>
										<button class="btn md fr" onclick="deleteImageSelect()" id="img_select_delete" style="display: none; margin-left: -1px;"><i class="icon-folder-open"></i>이미지 제거</button>
								...
								<div class="input_content_wrap">
									...
									<div class="input_content form_check">
										...
										<input type="checkbox" id="cont_homepagelink_select" onclick="insert_homepage_link(this);"><label for="cont_homepagelink_select">홈페이지 주소 자동삽입</label>
										<button class="btn md btn_emoticon fr" style="margin-left:10px;">카카오 이모티콘</button>
										<button class="btn md btn_emoji_kakao fr">특수문자</button>
								...
								<div class="input_content_wrap" <?if(!empty($iscoupon)) { echo 'style="display:none"'; } ?>>
								...
								<div class="input_content_wrap">
									...
									<div class="input_content form_check">
										...
										<div class="switch_content" id="hidden_fields_sms" style="display: none;">
											...
											<input type="checkbox" id="lms_kakaolink_select" onclick="insert_kakao_link(this);" style="cursor: default;"><label for="lms_kakaolink_select">카카오 친구추가 삽입</label>
											<button class="btn md fr" style="margin-left:10px;" onclick="getKakaoCont();">친구톡내용 가져오기</button>
											<button class="btn md btn_emoji fr">특수문자</button>
											<div class="clearfix"></div>
