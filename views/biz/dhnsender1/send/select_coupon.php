...
function re_templi_preview(obj) {
    ...
    title = title +	"<li style='padding-bottom: 10px;display: block;padding: 0 10px;color: rgb(46,172,188);font-size: 12px;'>사용기간 : ";
    title = title +	$("#id_cc_end_date").val() + "까지</li></div>";
    title = title + '<div id="btn_preview" style="height: 200px;padding-bottom: 2px; border:1px solid !important; border-color: #e8e8e8 !important; height:40px; margin-top:-1px !important;background-color:#ffd900;">' +
	 '<p data-always-visible="1" data-rail-visible="0" cols="20" readonly="readonly" ' +
	 'style="text-align: center !important; padding-top:10px !important; overflow:hidden;border:0;background-color:;resize:none;cursor:default;"' +
	 '>친구 추가</p></div>';
