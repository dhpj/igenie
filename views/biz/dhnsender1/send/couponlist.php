            ...
            <?$num=0;
    		  foreach($list as $r) {$num++;?>
                <tr align="center" name="select">
                    ...
                    <td class="text tmpl_code"><?=$r->cc_type?><input type="hidden" name="tpl_id" class="tpl_id" value="<?=$r->tpl_id?>" /><input type="hidden" name="cc_type" class="cc_type" value="<?=$r->cc_type?>" /></td>
