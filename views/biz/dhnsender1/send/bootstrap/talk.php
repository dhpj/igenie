												...
												if (Number(coin) - (Number(charge_type) * Number(row_index)) < 0) {
													...
													//if (mem_pay_type === "A") {
														...
														if (ms!="" && ($('#lms').val().replace(/ /gi, "") != "") && $("#lms_select").is(":checked") == true) {	// 2차문자 발송
															...
															content_msg += "예상 발송 금액 : "+ ((Number(at_price) * Number(row_index)).toFixed(2)).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + "원";
														}
												...
												if (Number(coin) - (Number(charge_type) * Number(upload_send)) < 0) {
													...
													//if (mem_pay_type === "A") {
														...
														if (ms!="" && ($('#lms').val().replace(/ /gi, "") != "") && $("#lms_select").is(":checked") == true) {	// 2차문자 발송
															...
															content_msg += "예상 발송 금액 : "+ ((Number(at_price) * Number(upload_send)).toFixed(2)).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + "원";
														}
