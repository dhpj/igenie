					...
					<div class="form_section">
						...
						<div class="inner_content">
                            ...
                            <table class="tpl_ver_form" width="100%" id="form1">
                                ...
                                ?>
                                <tr>
                                    <th>그룹명<span class="required">*</span></th>
                                    <td>
                                    	<input type="text" class="form-control input-width-large" name="group_name"
                                               id="group_name" placeholder="그룹명을 \"[그룹]\"을 빼고 입력해주세요." style="width:400px !important;">
                                ...
                                <? } ?>
                                <tr id="profile_key" >
                                    <th>그룹프로필Key<span class="required">*</span></th>
                                    <td>
                                        <input type="text" class="form-control input-width-large" name="pf_key_group"
                                               id="pf_key_group" placeholder="그룹프로필 키를 입력해주세요." style="width:400px !important;">
                                    </td>
                                </tr>
                            </table>
