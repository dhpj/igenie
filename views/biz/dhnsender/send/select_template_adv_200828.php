<?if($rs->tpl_profile_key) {?>
								...
								<div class="input_content_wrap">
									<div class="input_tit">
										<select style="width: 120px;" class="fl" name="btn_type1" id="btn_type">
                         <option disabled="disabled" value="WL" selected="">스마트전단</option>
                         <option disabled="disabled" value="AL">에디터사용</option>
                    </select>
									</div>
									<div class="input_content">
										<button class="btn_add btn_myModal" id="dh_myBtn">스마트전단 불러오기</button>
										<p class="noted">
										...
										<span class="info_text">* 링크로 이동할 페이지를 작성할 수 있습니다.</span> -->
										<div class="editor_box">
											<div class="url_info"><?=$dhnl_url?><!--button class="btn_copy"><span class="material-icons">file_copy</span> 주소복사</button--></div>
                                            ...
                                            if (btn_type == "DS" || btn_type == "BK" || btn_type == "MD") {
                                                ...
                                                if (btn_name != "") {
    												...
    												if(btn_type == "WL") {
    													...
    													html += "<input type=\"url\" style=\"width:100%;\" id=\"btn_url\" name=\"btn_url1\" placeholder=\"링크주소를 입력해주세요.\" value=\"<?=$dhnl_url?>\">";
    													html += "</div>";
    													html += "</div>";
    													if(url_link2 != null && url_link2 != "") {
        													...
        													html += "<button class=\"btn md fr\" style=\"margin-left: -1px;\" id=\"find_url\" onclick=\"urlConfirm(this);\">링크확인</button>";
        													html += "<div style=\"overflow: hidden;\">";
        													html += "<input type=\"url\" style=\"width:100%;\" id=\"btn_url\" name=\"btn_url2\" placeholder=\"링크주소를 입력해주세요.\" value=\"<?=$dhnl_url?>\">";
        													html += "</div>";
        													html += "</div>";
    													}
											...
											<div class="input_content form_check">
												...
												<div class="switch_content" id="hidden_fields_sms" style="display: none;">
													...
													<div class="msg_box">
														...
														<textarea class="input_msg" id="lms" name="lms" placeholder="'입력' 또는 '알림톡 내용 가져오기' 버튼을 클릭하세요." onkeyup="onPreviewLms();chkword_lms();">전단지정보
<?=str_replace('http://', '',$dhnl_url)?></textarea>
