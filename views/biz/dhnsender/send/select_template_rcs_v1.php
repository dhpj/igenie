...
<?if($rs->tpl_brand) {?>
	...
	<div class="input_content_wrap" style="display:<?=($tpl_button_cnt == 0&&$rcs_type=="T") ? "none" : ""?>;">
		...
		<div class="input_content">
            ...
            ?>
            <?php include_once($_SERVER['DOCUMENT_ROOT'].'/views/biz/dhnsender/send/bootstrap/_inc_leaflet_rcs_v1.php'); ?>
    ...
    // 알림톡 카테고리 클릭 2021-09-19
		...
		function adv_template_data() {
			...
			//알림톡버튼 데이타 조회
			$.ajax({
				url: "/dhnbiz/sender/send/rcs_v1/ajax_adv_template_data",
				type: "POST",
		...
		$("#modal_templet_list").sortable({
			stop: function(event, ui) {
				...
				$.ajax({
					url: "/dhnbiz/sender/send/rcs_v1/ajax_adv_template_sort",
					type: "POST",
