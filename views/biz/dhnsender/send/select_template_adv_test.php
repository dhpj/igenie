					...
					if (btn_name != "") {
						...
						if(btn_type == "WL") { //웹링크
							...
							if(btn_count == 1 && btn1_type == "E"){ //첫번째 버튼 & 버튼1타입(S.직접입력, E.에디터사용, L.스마트전단, C.스마트쿠폰)
								...
								html += "  <button class=\"btn md fr\" style=\"margin-left: -1px;\" id=\"find_url\" onclick=\"linkview();\">"+ btn_name +"</button>"; //첫번째 버튼
								html += "  <div style=\"overflow: hidden;\">";
								html += "    <input type=\"url\" style=\"width:100%;background:#f2f2f2;\" id=\"btn_url\" name=\"btn_url1\" placeholder=\"스마트쿠폰 불러오기 버튼을 클릭하세요.\" value=\"<?=$pcd_url?>\" readonly>";
								html += "  </div>";
								...
								html += "  <div style=\"overflow: hidden;\">";
								html += "    <input type=\"url\" style=\"width:100%;\" id=\"btn_url\" name=\"btn_url1\" placeholder=\"링크주소를 입력해주세요.\" value=\"http://<?=$this->member->item('mem_mall_id')?>.pfmall.co.kr\" onkeyup=\"btnUrlCopy(this, '"+ btn_count +"');\">";
								html += "  </div>";
							}else{
								html += "  <button class=\"btn md fr\" style=\"margin-left: -1px;\" id=\"find_url\" onclick=\"urlConfirm(this, '"+ btn_count +"');\">"+ btn_name +"</button>"; //두번째~ 버튼
								html += "  <div style=\"overflow: hidden;\">";
