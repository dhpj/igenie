	...
	*----------------------------------*/?>
								...
								if (check == true) {
									...
									$.ajax({
										...
										success: function (json) {
											...
											var kakao = Math.floor((Number(coin) + Number(bcoin)) / Number(rcs_charge));
	...
	function all_move() {
        ...
        if(sendFlag==false){
            ...
            // console.log("templi_cont.length : "+templi_cont.length);
            // return;
            // console.log("templi_cont : " + templi_cont);
            // return;
            ...
            // console.log("conall : "+ conall);
            //
            // return;
            // var gwang = "(광고)";
            // console.log("(광고) : "+ gwang.length);
            // return;
...
/*
	...
	<? if(!empty($spf)) { ?>
		...
		$('#send_template_content').html('').load(
			"/dhnbiz/sender/send/select_template_rcs_v1",
			{ <?=$this->security->get_csrf_token_name()?>: "<?=$this->security->get_csrf_hash()?>",
				add: "<?=$add?>",
    ...
    function selected_template(bottonId, tmp_flag) {
		...
		document.body.appendChild(form);
		form.setAttribute("method", "post");
		form.setAttribute("action", "/dhnbiz/sender/send/rcs_v1");
    ...
    function selected_rcs_type(rcs_type) {
		...
		document.body.appendChild(form);
		form.setAttribute("method", "post");
		form.setAttribute("action", "/dhnbiz/sender/send/rcs_v1<?=$addr?>");
	...
	function msg_save(use_yn){
		...
		$.ajax({
    		url: "/dhnbiz/sender/send/rcs_v1/save_adv_msg",
    		type: "POST",
    		data: {
    			 <?=$this->security->get_csrf_token_name() ?>: "<?=$this->security->get_csrf_hash() ?>"
	...
	// 		"/dhnbiz/sender/send/rcs_v1/msg_save_list",
	// 		{
	// 			<?=$this->security->get_csrf_token_name() ?>: "<?=$this->security->get_csrf_hash() ?>",
