		...
		<div class="inner_content preview_info">
			...
			<div class="input_content_wrap">
				...
				<div class="input_content">
					...
					<?=($rs->spf_key) ? $rs->spf_company : $po->mem_username ?>
					<!-- 메시지 미리보기 -->
				...
				<div class="input_content">
					<div class="msg_box">
						...
						<div class="txt_ad" id="lms_header">
							<span id="span_adv">(광고)</span><input type="text" class="input_option" style="width: 320px;" id="companyName" onkeyup="onPreviewText(); chkword_lms();" value="<? if ($rs->spf_company) { echo $rs->spf_company; } else { echo $po->mem_username; } ?>">
						</div>
						<textarea class="input_msg" id="lms" name="lms" placeholder="메세지를 입력해주세요." onkeyup="onPreviewText();chkword_lms();"></textarea>
						<span class="txt_byte"><span class="info_desc">80bytes가 넘어가면 장문 문자로 변경됩니다.</span><span class="msg_type_txt sms" id="lms_limit_str"></span><span id="lms_num">0</span>/<span id="lms_character_limit">80</span> bytes</span>
						<!--div class="txt_ad" id="lms_footer"></div-->
						<div class="txt_ad" id="lms_footer">
							<p id="kakotalk_link_text"></p><span id="span_unsubscribe">무료수신거부 : </span><input type="text" class="input_option" id="unsubscribe_num" onkeyup="onPreviewText(); chkword_lms();">
						</div>
					</div>
			...
			<div class="input_content_wrap">
				...
				<div class="input_content">
					<div class="checks">
						...
						<?php // 친구여부 추가및 명칭변경 끝 ?>    								    <div class="clearfix" style="margin-bottom: 10px;"></div>
							...
							<script type="text/javascript">
									...
									function ReserveCheck() {
										if($("#reserve_check").is(":checked") == true) {
											...
											$('#datetimepicker').datepicker({
												format:"yyyy-mm-dd"}).datepicker("setDate", "now");
...
$('#test_num_list').on(
			...
			<div class="modal-content">
				...
				<div class="modal-body select-body">
					...
					<div class="modal_bottom">
						<button type="button" class="btn md modal_cancel btn-default" data-dismiss="modal" onclick="cancelClick();">취소</button>
	...
	<!--프로필 선택-->
    <div class="modal fade" id="profile_danger" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" id="modal">
            <div class="modal-content">
	            <i class="material-icons modal_close" data-dismiss="modal">close</i>
                <div class="modal-body">
                    ...
                    <div class="modal_bottom">
						<button type="button" class="btn md modal_cancel btn-default" data-dismiss="modal">닫기</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal select fade" id="profile_select" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" id="modal">
            <div class="modal-content">
	            <i class="material-icons modal_close" data-dismiss="modal">close</i>
        ...
        <div class="modal-dialog" id="modal">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal_bottom">
                        <button type="button" class="btn md btn-primary enter" data-dismiss="modal" id="identify">확인</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog" id="modalCheck">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal_bottom">
                        <button type="button" class="btn md btn-default dismiss" data-dismiss="modal" onclick="cancelClick();">취소</button>
                        <button type="button" class="btn md btn-primary submit">확인</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog" id="modalCheck">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="content"></div>
                    <div class="modal_bottom">
                        <button type="button" class="btn md btn-default" data-dismiss="modal" onclick="cancelClick();">취소</button>
                        <button type="button" class="btn md btn-primary select-send" onclick="select_move();">확인</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog" id="modalCheck">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="content"></div>
                    <div class="modal_bottom">
                        <button type="button" class="btn md modal_cancel" data-dismiss="modal" onclick="cancelClick();">취소</button>
    ...
    <div class="modal fade" id="myModalTest" tabindex="-1" role="dialog" aria-labelledby="myModalCheckLabel" aria-hidden="true"><?//테스트 발송 모달?>
        <div class="modal-dialog" id="modalCheck">
            <div class="modal-content">
	            <i class="material-icons modal_close" data-dismiss="modal">close</i>
                <div class="modal-body">
                    ...
                    <div class="modal_bottom">
                        <!--<button type="button" class="btn md btn-default" data-dismiss="modal" onclick="cancelClick();">취소</button>-->
                        <button type="button" class="btn md modal_cancel" data-dismiss="modal" onclick="cancelClick();">취소</button>
                        <button type="button" class="btn md btn-primary test-send" onclick="test_move();">확인</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-lg" id="modalCheck">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="content"></div>
                    <div class="modal_bottom">
                        <button type="button" class="btn md btn-default" data-dismiss="modal">선택추가</button>
    ...
    <div class="modal select fade" id="myModalLoadCustomers" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden>
...
// 	}
	...
	$(document).ready(function() {
		...
		//var lms_header = '<span id="span_adv">(광고) </span>' + '<input type="text" id="companyName" onkeyup="onPreviewText()" value="'+ $("#pf_ynm").val() +'">'
...
// 	}
	...
	function all_send() {
    	...
    	//if ($("#switch_select").is(":checked") && $("input[name=checkOne]:checked").length == 0) {	// 고객 DB에서 그룹 선택
					...
					if(check == true) {
    					if($("#reserve_check").is(":checked") == true) {
    						if($("#reserve").val().trim() == ""){
    							...
    							if($("#reserve_hours").val() < 8 || $("#reserve_hours").val() > 20) {
    								$(".content").html("예약시간을 8:00 부터 20:50사이로 입력해주세요.");
    								$('#myModal').modal({backdrop: 'static'});
    								check = false;
    							} else {
    								//var reserve = $("#reserve").val().replace(/ /gi, "").replace(/-/gi, "").replace(/시/gi, "").replace(/분/gi, "");
						...
						$.ajax({
							...
							success: function (json) {
								...
								if (!$("#switch_upload").is(":checked")) {
									var row_index = 0;
									var content_msg = "<div class='modal_info_row'><label>발송 가능 건수</label>" + resend_cnt + "건</div>";
									...
									if (Number(coin) - (Number(send_price) * Number(upload_send)) < 0) {
										$(".content").html("잔액이 부족합니다.<BR>잔액:"+coin+"<BR>예상금액:"+(Number(send_price) * Number(upload_send)));
										$('#myModal').modal({backdrop: 'static'});
										$(document).unbind("keyup").keyup(function (e) {
											var code = e.which;
											if (code == 13) {
...
/*-------------------------------------------------------------------------------*/
	...
	function all_move() {
		...
		if ($("#switch_upload").is(":checked") && parseInt($("#upload_tel_count").text()) > 0) {		// upload 발송
			...
			file_data.append("link_type", link_type); //전단종류(smart.스마트전단, editor.에디터 사용)
		...
		//} else if ($("#switch_select").is(":checked") && $("input[name=checkOne]:checked").length > 0) {	// 고객 DB에서 그룹 선택
			...
			//});
			//alert("groupId 2 : "+ $("#groupId").val()); return;
			var groupId_sp = $("#groupId").val().split("§§");
			var groupId = groupId_sp[0]; //그룹번호
...
//								check_resend_method();
								...
								$(".content").html(limit_msg + content_msg + "<br/><br/>테스트 발송하시겠습니까?<br/> 발송할 건수 : " + row_index + " 건" );
