		...
		function getLinkCont() {
			...
			// 	dumyTempli_cont = dumyTempli_cont.replace(/<p> <\/p>/gi, '\n\n');
				if(get_btn_cnt > 0){ //버튼이 있는 경우
					...
					// if(link_type == "smartEditor"){ //스마트전단+에디터
					// 	if(document.getElementById("psd_url").value!=''){
					// 		if(btn_url!=''){
					// 			newline = "\n";
					// 		}
					// 		btn_url += newline + "행사보기\n" + document.getElementById("psd_url").value; //에디터 링크 URL
					// 	}
					// 	if(document.getElementById("dhnl_url").value!=''){
					// 		if(btn_url!=''){
					// 			newline = "\n";
					// 		}
					// 		btn_url += newline + "행사보기\n" + document.getElementById("dhnl_url").value; //에디터 링크 URL
					// 	}
					//
					// }
					// if(link_type == "editor"){ //에디터
					...
					// 			newline = "\n";
					// 		}
					// 		btn_url += newline + "행사보기\n" + document.getElementById("psd_url").value; //스마트전단 링크 URL
					// 	}
					// }
					//
					// if(link_type == "coupon"){ //스마트쿠폰
					// 	if(document.getElementById("pcd_url").value !=''){
					// 		if(btn_url!=''){
					// 			newline = "\n";
					// 		}
					// 		btn_url += newline + "쿠폰받기\n" + document.getElementById("pcd_url").value; //스마트쿠폰 링크 URL
					// 	}
					// }
					//
					...
					// 			newline = "\n";
					// 		}
					// 		btn_url += newline + "행사보기\n" + document.getElementById("btn_url").value; //스마트쿠폰 링크 URL
					// 	}
					// }
...
/*
	...
	function chg_link_type(){
		...
		if(link_type == "self"){ //직접입력
			...
			document.getElementById("div_smart_goods_call").style.display = "none"; //행사정보 가져오기 영역 닫기
		...
		}else if(link_type == "smartEditor"){ //스마트전단+에디터
			btn_url = document.getElementById("psd_url").value; //스마트전단 링크 URL
			...
			document.getElementById("div_smart_box").style.display = "none"; //스마트전단 영역 닫기
			document.getElementById("div_coupon_box").style.display = "inline"; //스마트쿠폰 영역 열기
			document.getElementById("div_editor_box").style.display = "none"; //에디터 영역 닫기
			document.getElementById("div_blank_box").style.display = "none"; //사용안함 영역 닫기
			document.getElementById("div_smart_goods_call").style.display = "none"; //행사정보 가져오기 영역 닫기
		}else{ //스마트전단
