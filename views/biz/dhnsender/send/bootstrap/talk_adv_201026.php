<?
	//같이 수정해야 됨 /views/biz/dhnsender/send/select_template_adv.php
	$bt1_tpl_id = "77"; //버튼타입 1 템플릿번호
	$bt2_tpl_id = "78"; //버튼타입 2 템플릿번호
	$bt3_tpl_id = "67"; //버튼타입 3 템플릿번호

	//버튼타입 1 템플릿번호 변경시
	//같이 수정해야 됨 controllers/dhnbiz/sender/send/Talk_adv.php
?>
			...
			<div class="input_content_wrap">
				...
				<div class="input_content">
					<div class="checks">
						...
						<input type="radio" name="customer" value="db" id="switch_select" checked /><label for="switch_select">그룹 선택</label>
						<input type="radio" name="customer" value="upload" id="switch_upload" /><label for="switch_upload">파일업로드</label>
						<input type="radio" name="customer" value="private" id="switch_customer" /><label for="switch_customer">직접 입력</label>
						...
						<div class="widget-content reserve_content">
							<div class="datepicker_wrap">
								<div class='input-group date fl' id='datetimepicker' style="width: 135px;">
									...
									<span class="input-group-addon"><span class="material-icons" style="font-size:18px;">date_range</span></span>
								</div>
...
<!-- /form-->
<div class="modal select fade" id="sendbox_select" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<div class="modal fade" id="template_danger" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog" id="modal">
		<div class="modal-content">
			...
			<div class="modal_title">템플릿 선택하기</div>
			<div class="modal_body">
				<div class="content">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog width_400" id="modal">
		<div class="modal-content">
			<i class="material-icons modal_close" data-dismiss="modal" id="identify">close</i>
			<div class="modal-body icon_alarm">
				<div class="content identify"></div>
				<div class="modal_bottom">
					<button type="button" class="btn md enter" data-dismiss="modal" id="identify">확인</button>
				</div>
			</div>
		</div>
	</div>
...
<div class="modal fade" id="myModalCheck" tabindex="-1" role="dialog" aria-labelledby="myModalCheckLabel" aria-hidden="true">
...
<div class="modal fade" id="myModalSelect" tabindex="-1" role="dialog" aria-labelledby="myModalCheckLabel" aria-hidden="true">
	<div class="modal-dialog" id="modalCheck">
...
<!-- 발송후 발송 내역 -->
<div class="modal fade" id="myModalAll" tabindex="-1" role="dialog" aria-labelledby="myModalCheckLabel" aria-hidden="true">
	<div class="modal-dialog" id="modalCheck">
		<div class="modal-content">
			<i class="material-icons modal_close" data-dismiss="modal">close</i>
			<div class="modal_title">발송</div>
			<div class="modal-body">
				<div class="content"></div>
				<div class="modal_bottom">
					<button type="button" class="btn md modal_cancel" data-dismiss="modal">취소</button>
					<button type="button" class="btn md all" onclick="all_move();">확인</button>
				</div>
			</div>
...
<div class="modal fade" id="myModalTest" tabindex="-1" role="dialog" aria-labelledby="myModalCheckLabel" aria-hidden="true">
	<div class="modal-dialog" id="modalCheck">
		<div class="modal-content">
			<i class="material-icons modal_close" data-dismiss="modal">close</i>
			<div class="modal_title">테스트 발송</div>
			<div class="modal-body">
				<div class="content"></div>
				<div class="modal_bottom">
					<button type="button" class="btn md modal_cancel" data-dismiss="modal">취소</button>
					<button type="button" class="btn md test-send" onclick="test_move();">확인</button>
				</div>
			</div>
		</div>
	</div>
</div>
<div class="modal fade" id="myModalDel" tabindex="-1" role="dialog" aria-labelledby="myModalCheckLabel" aria-hidden="true">
	<div class="modal-dialog" id="modalCheck">
		<div class="modal-content select_send">
			<i class="material-icons modal_close" data-dismiss="modal">close</i>
			<div class="modal_title">
...
<div class="modal fade" id="myModalSelDel" tabindex="-1" role="dialog" aria-labelledby="myModalCheckLabel" aria-hidden="true">
	<div class="modal-dialog" id="modalCheck">
		<div class="modal-content select_send">
			<i class="material-icons modal_close" data-dismiss="modal">close</i>
			<div class="modal_title">
...
<div class="modal fade" id="myModalTemp" tabindex="-1" role="dialog" aria-labelledby="myModalCheckLabel" aria-hidden="true">
	<div class="modal-dialog" id="modalCheck">
		<div class="modal-content select_send">
			<i class="material-icons modal_close" data-dismiss="modal">close</i>
			<div class="modal_title">
...
<div class="modal fade" id="myModalUpload" tabindex="-1" role="dialog" aria-labelledby="myModalCheckLabel" aria-hidden="true">
	<div class="modal-dialog" id="modalCheck">
		<div class="modal-content select_send">
			<i class="material-icons modal_close" data-dismiss="modal">close</i>
			<div class="modal_title">
			...
			<div class="modal-body">
				<div class="content"></div>
				<div>
					<button type="button" class="btn md up">확인</button>
				</div>
			</div>
		</div>
	</div>
</div>
<div class="modal fade" id="myModalDownload" tabindex="-1" role="dialog" aria-labelledby="myModalCheckLabel" aria-hidden="true">
	<div class="modal-dialog" id="modalCheck">
		<div class="modal-content select_send">
			<i class="material-icons modal_close" data-dismiss="modal">close</i>
			<div class="modal_title">
...
<div class="modal fade" id="myModalFilterAll" tabindex="-1" role="dialog" aria-labelledby="myModalCheckLabel" aria-hidden="true">
...
// 	}
	...
	function getArimtalkCont() {
		...
		if(dumyTempli_cont != ""){
			...
			<? if($tpl->tpl_id == $bt1_tpl_id or $tpl->tpl_id == $bt2_tpl_id){ //링크버튼형 ?>
		...
		//alert("dumyTempli_cont : "+ dumyTempli_cont); return;
...
<?/*--------------------*
    ...
    *--------------------*/?>
    function urlConfirm(obj, bno) {
		...
		//alert("link_type : "+ link_type +", bno : "+ bno); return;
    	if(url != "") {
    		if(pattern.test(url)) {
				...
				if(link_type == "editor" && bno == "1"){ //에디터 && 첫번째 버튼
					...
					$.ajax({
						...
						data: {
							...
							,"bizurl" : bizurl //에디터코드
							,"html" : html //에디터내용
							,"link_type": link_type //전단종류(smart.스마트전단, editor.에디터 사용)
					...
					editor_preview(url); //스마트전단 미리보기
				}else if(link_type == "smart" && bno == "1"){ //스마트전단 && 첫번째 버튼
...
<?/*----------------------------------*
	...
	*----------------------------------*/?>
	...
	function all_send() {
		...
		if (link_type == "editor" && summ == '<p><span style="font-size: 18px;">﻿</span><br></p>') { //에디터의 경우
			alert("에디터 내용을 입력하세요.");
			$("#link_type").focus();
			return;
		}
		if(templi_id == "<?=$bt1_tpl_id?>" || templi_id == "<?=$bt2_tpl_id?>"){ //링크버튼형
			//alert("psd_code : "+ psd_code);
			if(link_type == "smart" && psd_code == ""){ //스마트전단의 경우
				alert("스마트전단을 선택하세요.");
		...
		if (chkword_lmsCount() > 2000){
			alert("2차 발송 내용은 2,000byte(한글 1,000자)이내로<br/>입력하여야 합니다.");
			$("#lms").focus();
			return;
		}
		...
		if(1 == 1){
			...
			$.ajax({
				url: "/dhnbiz/sender/talk/equal_send_mem_id",
				type: "POST",
								...
								if (check == true) {
									...
									$.ajax({
										...
										success: function (json) {
											...
											if(limit > 0) {
												limit_msg = "<font color='blue'>금일 발송가능 : " + (limit - sent).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',').replace(/NaN/,'0') + "건</font>";
											}
											...
											if (!$("#switch_upload").is(":checked")) {
												...
												if (Number(coin) - (Number(charge_type) * Number(row_index)) < 0) {
													$(".content").html("<h4 class='modal_icon_alarm'>잔액이 부족합니다.<h4><p>잔액:"+coin+"</p><p>예상금액:"+(Number(charge_type) * Number(row_index))) + "</p>";
													$('#myModal').modal({backdrop: 'static'});
													$(document).unbind("keyup").keyup(function (e) {
														var code = e.which;
														if (code == 13) {
													...
													if(1 == 1){
														...
														if (ms!="" && ($('#lms').val().replace(/ /gi, "") != "") && $("#lms_select").is(":checked") == true) {	// 2차문자 발송
															...
															content_msg += "<div class='modal_info_row'><label>예상 발송 금액</label>"+ ((Number(at_price) * Number(row_index)).toFixed(2)).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + "원</div>";
														}
												...
												if (Number(coin) - (Number(charge_type) * Number(upload_send)) < 0) {
													$(".content").html("<h4 class='modal_icon_alarm'>잔액이 부족합니다.<h4><p>잔액:"+coin+"</p><p>예상금액:"+(Number(charge_type) * Number(upload_send))) + "</p>";
													$('#myModal').modal({backdrop: 'static'});
													$(document).unbind("keyup").keyup(function (e) {
														var code = e.which;
														if (code == 13) {
													...
													//if (mem_pay_type === "A") {
														...
														if (ms!="" && ($('#lms').val().replace(/ /gi, "") != "") && $("#lms_select").is(":checked") == true) {	// 2차문자 발송
															...
															content_msg += "<div class='modal_info_row'><label>예상 발송 금액</label>"+ ((Number(at_price) * Number(upload_send)).toFixed(2)).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + "원</div>";
														}
	...
	function all_move() {
		...
		if(msg != '') {		// 2차 문자가 있으면(웹(A)LMS : wa, 웹(A)SMS : was, 웹(A) MMS : wam, 웹(B)LMS : wb, 웹(B)SMS : wbs, 웹(B) : wbm, 폰문자: phn
			...
			if(temp_mst_kind == "GREEN_SHOT") {
    			...
    			if (resend_type != "L" && resend_type != "P") {
    				...
    				if (resend_type == "S" || resend_type == "M") {
    					mst_type2 = "wc" + temp_resend_type;
    				} else {
    					mst_type2 = "wa" + temp_resend_type;
    				}
		...
		var link_type = $("#link_type").val(); //전단종류(smart.스마트전단, editor.에디터 사용)
		...
		if ($("#switch_upload").is(":checked") && parseInt($("#upload_tel_count").text()) > 0) { //파일업로드 발송
			...
			file_data.append("link_type", link_type); //전단종류(smart.스마트전단, editor.에디터 사용) 2020-09-16 추가
			...
			//alert(couponid);
			$.ajax({
				url: "/dhnbiz/sender/talk/adv_send",
				type: "POST",
				data: file_data,
				processData: false,
				contentType: false,
		...
		//} else if ($("#switch_select").is(":checked") && $("input[name=checkOne]:checked").length > 0) {	// 고객 DB에서 그룹 선택
			...
			var groupId_sp = $("#groupId").val().split("§§");
			var groupId = groupId_sp[0]; //그룹번호
			customer_filter = "groupId"+ groupId;
			//alert("customer_all_count : "+ customer_all_count +", customer_filter : "+ customer_filter);
			$.ajaxSettings.traditional = true;
			$.ajax({
				url: "/dhnbiz/sender/talk/adv_send",
				type: "POST",
				data: {"<?=$this->security->get_csrf_token_name()?>":"<?=$this->security->get_csrf_hash()?>",
					...
					"bizurl": $("#biz_url").val(),
					"link_type": link_type, //전단종류(smart.스마트전단, editor.에디터 사용) 2020-09-16 추가
...
/*
		...
		for (var i = 0; i < temp.length; i++) {
			if (i == 0) {
				...
				if (varName == "#{변수내용}") {
					...
					returnTempli_cont = returnTempli_cont + "<textarea name=\"var_name\" id=\"var_name\" class=\"var multi\" onkeyup=\"return view_preview();\" placeholder=\"" + varName + "\"></textarea>";
				} else if (varName == "#{업체명}") {
					returnTempli_cont = returnTempli_cont + "<textarea name=\"var_name\" class=\"var single\" onkeyup=\"return view_preview();\" onKeypress=\"if(event.keyCode==13) { event.preventDefault(); }\" placeholder=\"" + varName + "\"><?= $this->member->item('mem_username')?></textarea>";
				} else if (varName == "#{업체전화번호}" || varName == "#{전화번호}" ) {
					var tel = autoHypenPhone("<?= $this->member->item('mem_phone')?>");
					returnTempli_cont = returnTempli_cont + "<textarea name=\"var_name\" class=\"var single\" onkeyup=\"return view_preview();\" onKeypress=\"if(event.keyCode==13) { event.preventDefault(); }\" placeholder=\"" + varName + "\">"+ tel +"</textarea>";
				} else {
					// 멀티라인이 필요없는 변수 한줄짜리.
					returnTempli_cont = returnTempli_cont + "<textarea name=\"var_name\" class=\"var single\" onkeyup=\"return view_preview();\" onKeypress=\"if(event.keyCode==13) { event.preventDefault(); }\" placeholder=\"" + varName + "\"></textarea>";
				}
				returnTempli_cont = returnTempli_cont + varsplit[1];
			}
		}
	...
	<? if(!empty($spf)) { ?>
		$('#send_template_content').html('').load(
			"/dhnbiz/sender/send/select_template_adv",
			{ <?=$this->security->get_csrf_token_name()?>: "<?=$this->security->get_csrf_hash()?>",
    ...
    //템플릿내용 선택
	function selected_template(bottonId) {
		var selected_temp = "";
		if ($("#"+bottonId).hasClass("on") == true) {
			//alert("ON");
			return;
		}
		if (bottonId == "selected_temp2") { //링크버튼<br>[행사보기]
			selected_temp = "<?=$bt1_tpl_id?>";
		} else if (bottonId == "selected_temp3") { //링크버튼<br>[행사보기]<br>[주문하기]
			selected_temp = "<?=$bt2_tpl_id?>";
		} else { //링크버튼 없음<br>[버튼없음]
			selected_temp = "<?=$bt3_tpl_id?>";
		}
        ...
        var form = document.createElement("form");
			document.body.appendChild(form);
			form.setAttribute("method", "post");
			form.setAttribute("action", "/dhnbiz/sender/send/talk_adv");
			...
			selectedField.setAttribute("value", selected_temp);
			form.appendChild(selectedField);
...
// 			form.appendChild(nft_);
	...
	function chg_link_type(){
		...
		var btn_rul = "";
		//alert("link_type : "+ link_type +", tpl_id : <?=$tpl->tpl_id?>");
		if(link_type == "self"){ //직접입력
			...
			btn_rul = document.getElementById("psd_url").value; //스마트전단 링크 URL
			document.getElementById("div_smart_box").style.display = ""; //스마트전단 영역 열기
			document.getElementById("div_editor_box").style.display = "none"; //에디터 영역 닫기
			document.getElementById("div_blank_box").style.display = "none"; //사용안함 영역 열기
		}
		//알림톡 버튼 URL 변경
		...
		$("div[name='field-data']").each(function () {
			...
			if (btn_type != undefined && btn_cnt == 1) { //첫번째 버튼만 링크 추가
				$(this).find(document.getElementsByName("btn_url1")).val(btn_rul);
				$(this).find(document.getElementsByName("btn_url2")).val(btn_rul);
				if(link_type == "smart" || link_type == "editor"){ //스마트전단 or 에디터
		...
		var lms_smart_msg = "";
		if(tpl_id == "<?=$bt1_tpl_id?>" || tpl_id == "<?=$bt2_tpl_id?>"){ //링크버튼형
			lms_smart_msg = "행사보기\n"+ btn_rul; //2차발송 내용
		}
		//2차발송 세팅
		document.getElementById("lms").value = lms_smart_msg; //2차발송 내용
		onPreviewLms();
		chkword_lms();
	}
		...
		$.ajax({
			...
			success: function(json){
				...
				if(btn_rul != ""){
					...
					document.getElementById("psd_url").value = btn_rul; //스마트전단 링크 URL
	...
	//알림톡 내용저장
	function msg_save() {
		var temp_id = $('#templi_id').val();
		var vars = [];
		$("textarea[name^='var_name']").each(function(){
			vars.push($(this).val());
		});
		//console.log(vars);
		var umsurl = $("#dhnl_url").val();
		var ums_cont = $('#summernote').summernote('code');
		var temp_cont = getTempli();
		$.ajax({
    		url: "/dhnbiz/sender/send/talk_adv/save_adv_msg",
    		type: "POST",
    		data: {
    			<?=$this->security->get_csrf_token_name() ?>: "<?=$this->security->get_csrf_hash() ?>",
    			"temp_id": temp_id,
	...
	function open_page_user_lms_msg(page, delids) {
		...
		$('#myModalUserMSGList .content').html('').load(
			"/dhnbiz/sender/send/talk_adv/msg_save_list",
			{
				<?=$this->security->get_csrf_token_name() ?>: "<?=$this->security->get_csrf_hash() ?>",
