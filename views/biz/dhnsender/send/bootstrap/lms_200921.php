...
<div id="mArticle">
	<div class="form_section">
		...
		<div class="inner_content preview_info">
			...
			<input type="hidden" name="dhnl_url" id="dhnl_url"  value="<?=$dhnl_url?>" style="width:150px;">
			<input type="hidden" name="psd_url" id="psd_url"  value="<?=$psd_url?>" style="width:250px;">
...
// 	}
	...
	function onPreviewText() {
		...
		var link_type = $("#link_type").val(); //전단타입
