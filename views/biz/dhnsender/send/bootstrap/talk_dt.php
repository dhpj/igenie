							...
							<div class="input_content_wrap">
								...
								<div class="input_content">
									<div class="checks">
									    ...
									    <div id="upload">
										    <div class="msg_box">
											    <div class="btn_group" style="border-bottom: 1px solid #dedede;">
													<button class="btn md excel fr" onclick="download();">엑셀양식 다운로드</button>
									...
									<div class="msg_box">
										<div class="send_list">
											...
											<div class="test_send_num_add">
												<button class="btn md yellow fr" id="btn-test-send" onclick="test_send();" style="margin-left: 5px;">테스트 발송</button>
