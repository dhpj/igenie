				...
				<div id="mArticle">
					<div class="form_section">
						...
						<div class="inner_content preview_info">
							<div id="send_friend_content" class="inner_content preview_info">
							</div>
							<div class="input_content_wrap">
								...
								<div class="input_content">
									<div class="checks">
									    ...
									    <div id="upload">
										    <div class="msg_box">
											    <div class="btn_group" style="width:100%; padding: 10px; text-align: center; border-bottom: 1px solid #dedede;">
...
//                                 						});
					...
					<div class="btn_group_lg">
						...
						<button class="btn lg color" onclick="all_send();">보내기</button>
					</div>
					<div class="footer">
						<div class="cs_info">
							<div class="cs_call">
...
<?}?>
		$('#send_friend_content').html('').load(
			(document.location.href.indexOf("/sender/send/friend_dt") > -1) ? "/dhnbiz/sender/send/select_profile_dt" : "",
			{ <?=$this->security->get_csrf_token_name()?>: "<?=$this->security->get_csrf_hash()?>" },
			function() {
				if(document.location.href.indexOf("/sender/send/friend_dt") > -1) {
	...
	function select_profile() {
		...
		if(activeTr.length == 0 ) {
			...
			$('#send_friend_content').html('').load(
				"/dhnbiz/sender/send/select_profile_dt",
				{
					<?=$this->security->get_csrf_token_name()?>: "<?=$this->security->get_csrf_hash()?>",
...
<?}?>
	...
	*/
	...
	function all_move() {
		...
		var smsOnly='';
		var cont_header_temp = $("#cont_header").html().replace("<BR>", "\n").replace("<br>", "\n");
