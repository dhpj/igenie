...
$('#test_num_list').on(
	...
	<div class="modal select fade" id="sendbox_select" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog width_900" id="modal">
	...
	function all_move() {
		...
		$("div[name='field-data']").each(function () {
			...
			if (btn_type != undefined) {
				...
				var temp_url_http = "";
				if (btn_type == "WL") {
					temp_url_http = $(this).find(document.getElementsByName("btn_url_http1")).text();
					console.log("temp_url_http1 :" + temp_url_http);
					...
					if (temp_url.length < 2) {
						...
						if(temp_url_http.trim() == '') {
							console.log("temp_url_http2 :" + temp_url_http);
							obj[btn_num].url_mobile = $(this).find(document.getElementsByName("btn_url1")).val();
						} else {
							console.log("temp_url_http3 :" + temp_url_http);
					...
					if ($(this).find(document.getElementsByName("btn_url2")).val() != undefined) {
						temp_url_http = $(this).find(document.getElementsByName("btn_url_http2")).text();
						console.log("temp_url_http4 :" + temp_url_http);
						var temp_url = $(this).find(document.getElementsByName("btn_url2")).val().trim().split("://");
						if (temp_url.length < 2) {
							console.log("temp_url_http5 :" + temp_url_http);
							...
							if(temp_url_http.trim() == '') {
								console.log("temp_url_http6 :" + temp_url_http);
								obj[btn_num].url_pc = $(this).find(document.getElementsByName("btn_url2")).val();
							} else {
								console.log("temp_url_http7 :" + temp_url_http);
					...
					if (temp_url2.length < 2) {
						...
						if(temp_url_http.trim() == '') {
							obj[btn_num].scheme_android = $(this).find(document.getElementsByName("btn_url2")).val();
						} else {
