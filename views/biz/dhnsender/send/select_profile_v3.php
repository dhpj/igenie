...
<div class="input_content_wrap">
	...
	<div class="input_content">
        ...
        <input type="hidden" id="pf_public_id" value="<?=$rs->spf_public_id?>"/>
        ...
        <input type="hidden" name="dhnl_url_s" id="dhnl_url_s"  value="<?=$dhnl_url_s?>" style="width:160px;">
        <input type="hidden" name="editor_title" id="editor_title"  value="" style="width:160px;">
        ...
        <input type="hidden" name="psd_url_s" id="psd_url_s"  value="<?=$psd_url_s?>" style="width:160px;">
        <input type="hidden" name="psd_title" id="psd_title"  value="" style="width:160px;">
        ...
        <input type="hidden" name="pcd_title" id="pcd_title"  value="" style="width:160px;">
        <input type="hidden" name="pcd_url" id="pcd_url"  value="<?=$pcd_url?>" style="width:160px;">
        <input type="hidden" name="pcd_url_s" id="pcd_url_s"  value="<?=$pcd_url_s?>" style="width:160px;">
		...
		<input type="hidden" name="find_linkbtn_name" id="find_linkbtn_name" value="행사보기">
		...
		<div id="image_list_modal" class="dh_modal">
		  ...
		  <div class="modal-content md_width970">
			  ...
			  <p class="modal-tit t_al_left">친구톡 이미지 관리</p>
				...
				<p class="modal_info">
					* 이미지 권장 사이즈 : <span>720px X 720px</span> / 지원 파일형식 및 크기 : <span>jpg</span> / 최대용량 : <span>500KB</span>
...
<div class="input_content_wrap">
	...
	<div class="input_content">
				...
				<div class="input_link_wrap">
                    ...
                    <div id='div_smart_box' style="display:none;">
                        ...
                        <div id='div_smart_goods_call'>
                            <button class='btn_con_copy btn_myModal' onClick="smart_goods_call('ft');">행사정보 가져오기</button>
                        </div>
                    </div>
                    ...
                    <select style="width: 120px;" class="fl"  name="link_type0" id="link_type00" onchange='chg_link_type(0);'>
					...
					<div style="overflow: hidden;" id="btn_web_like_"><input type="text" name="btn_name2" id="btn_name2_" style="width:100%; margin-left: -1px;" placeholder="버튼명을 입력해주세요"  maxlength="26" onkeyup="link_name(this,0);scroll_prevent();"></div>
		...
		<div id="field"></div>
        <?php include_once($_SERVER['DOCUMENT_ROOT'].'/views/biz/dhnsender/send/bootstrap/_inc_leaflet_friend_v3.php'); ?>
	</div>
...
function image_list_open(page){
	//카카오톡 이미지 리스트 조회
	$.ajax({
		url: "/dhnbiz/sender/send/friend_v3/ajax_image_list",
		type: "POST",
...
function add_info(x) {
	...
	if ( fieldid < 5) {	// 5개만 생성
        ...
        var pf_public_id = $("#pf_public_id").val();
        // $("#btn_url"+(fieldid + 1)).val("http://plus-talk.kakao.com/plus/home/" + pf_yid);
        $("#btn_url"+(fieldid + 1)).val("http://pf.kakao.com/" + pf_public_id);
...
$(document).ready(function(){
    // var selecttype = $("#link_type_option1").val();
    // buttonArr.push("smart");
    // $("#link_type1").val("smart").prop("selected", true);
    // chg_link_type('1');
 });
...
<div class="input_content_wrap" style="display:inline-block;width:100%;">
	...
	<div class="input_content">
        ...
        <button id="getLink_btn" class="btn md fr" onclick="getLinkCont();">링크 가져오기</button>
...
<div class="input_content_wrap" id="jump_3rd" style="display: none;">
	...
	<div class="input_content">
        ...
        <button id="getLink_btn2" class="btn md fr" onclick="getLinkCont2();">링크 가져오기</button>
...
<script >
    ...
    $(".btn_emoji2").click(function () {
		$(".toggle_layer_emoji2").slideToggle("fast");
	});

	$(".btn_emoji_kakao").click(function () {
        // if ($("#btn_emoticon").css("display") == "block") {
		// 	$("#btn_emoticon").css("display", "none");
		// }
		// if ($("#toggle_layer_emoticon").css("display") == "block") {
		// 	$("#toggle_layer_emoticon").css("display","none");
		// } else {
		// 	$("#toggle_layer_emoticon").css("display","block");
		// }
		if ($(".toggle_layer_emoticon").css("display") == "block") {
    ...
    // $(".btn_emoji").click(function () {
	// 	if ($("#btn_emoji").css("display") == "block") {
	// 		$("#btn_emoji").css("display","none");
	// 	} else {
	// 		$("#btn_emoji").css("display","block");
	// 	}
	// });
    //
	// $(".btn_emoji2").click(function () {
	// 	if ($("#btn_emoji2").css("display") == "block") {
	// 		$("#btn_emoji2").css("display","none");
	// 	} else {
	// 		$("#btn_emoji2").css("display","block");
	// 	}
	// });
