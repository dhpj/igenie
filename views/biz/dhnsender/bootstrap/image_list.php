...
<!-- 타이틀 영역 END -->
    <form action="/biz/sender/image_list" method="post" id="mainForm">
        <input type='hidden' name='<?=$this->security->get_csrf_token_name()?>' value='<?=$this->security->get_csrf_hash()?>' />
 				<div id="mArticle">
					<div class="form_section">
						...
						<div class="tab_group">
						    <button class="btn" type="button" onclick="javascript:click_bntimage()"><i class="material-icons">add</i> 일반 이미지추가</button>
						...
						<div class="inner_content">
							...
							<div class="notice_wrap">
                                <p>* 권장 사이즈 : 720 x 720px / 제한 사이즈 - 가로 500px 미만 또는 가로:세로 비율이 2:1 미만 또는 3:4 초과시 업로드 불가 / 지원 파일형식 및 크기 : jpg, png / 최대 500KB</p>
                                <p>* 이미지를 클릭하여 상세 이미지를<!--와 이미지URL(친구톡 업로드 발송시 필요)을--> 확인하세요. </p>
                            </div>
...
*/
                    ...
                    function showResult(json) {
                        ...
                        if (json['code'] == 'success') {
                            window.location.href = '/biz/sender/image_list';
                        }
                        else {
