                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="align-center">Fullcare</th>
                    ...
                    <?php
                        ...
                        foreach ($list as $r) {
                            ...
                            <tr>
                                ...
                                <? } ?>
                                <td class="align-right"><?php echo number_format($r->deposit); ?></td>
                                <td class="align-right"><?php echo number_format($r->full_care); ?></td>
                                <td class="align-right"><?php echo number_format($r->at); ?></td>
                                <td class="align-right"><?php echo number_format($r->ft); ?></td>
                                <td class="align-right"><?php echo number_format($r->ft_img); ?></td>
                                <td class="align-right"><?php echo number_format($r->ft_w_img); ?></td>
                                ...
                                <td class="align-right"><?php echo number_format($row_sum); ?></td>
                                <td class="align-right"><?php echo number_format($row_amount_sum); ?></td>
                    ...
                    ?>
                            <tr>
                                ...
                                <td class="align-right"><?php echo number_format($sum_fullcare); ?></td>
                                ...
                                <td class="align-right"><?php echo number_format($sum_send); ?></td>
                                <td class="align-right"><?php echo number_format($sum_send_amount); ?></td>
