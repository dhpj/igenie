						...
						<div class="table_stat_header">
							<table cellspacing="0" cellpadding="0" border="0">
			                    ...
			                    <thead>
			                        <? if ($this->member->item('mem_userid') == 'dhnadmin' || $this->member->item('mem_userid') == 'dhn') { ?>
			                        <tr>
			                        	<th class="align-center" rowspan="3"><input type="checkbox" name="check_all" id="row_check_all" class="uniform" onclick="offer_row_check_all();"></th>
			                            <th class="align-center" rowspan="3">업체명</th>
			                            <th class="align-center" rowspan="3">Fullcare</th>
			                            <th class="align-center" colspan="3"><input type="checkbox" name="col_check" value="at" class="uniform" checked></th>
			                            <th class="align-center" colspan="3"><input type="checkbox" name="col_check" value="ft_txt" class="uniform" checked></th>
			                            <th class="align-center" colspan="3"><input type="checkbox" name="col_check" value="ft_img" class="uniform" checked></th>
			                            <th class="align-center" colspan="3"><input type="checkbox" name="col_check" value="ft_w_img" class="uniform" checked></th>
			                            <th class="align-center" colspan="6"><input type="checkbox" name="col_check" value="grs_lms" class="uniform" checked></th>
			                            <th class="align-center" colspan="3"><input type="checkbox" name="col_check" value="grs_sms" class="uniform" ></th>
			                            <th class="align-center" colspan="3"><input type="checkbox" name="col_check" value="grs_mms" class="uniform"></th>
			                            <th class="align-center" colspan="3"><input type="checkbox" name="col_check" value="nas_lms" class="uniform" checked></th>
			                            <th class="align-center" colspan="3"><input type="checkbox" name="col_check" value="nas_sms" class="uniform"></th>
			                            <th class="align-center" colspan="3"><input type="checkbox" name="col_check" value="nas_mms" class="uniform"></th>
			                            <th class="align-center" colspan="3"><input type="checkbox" name="col_check" value="smt_lms" class="uniform" checked></th>
			                            <th class="align-center" colspan="3"><input type="checkbox" name="col_check" value="smt_sms" class="uniform"></th>
			                            <th class="align-center" colspan="3"><input type="checkbox" name="col_check" value="smt_mms" class="uniform"></th>
			                            <th class="align-center" rowspan="3">총 수익</th>
			                        </tr>
			                        <? } ?>
			                        <tr>
