<div class="crumbs">
	<ul id="breadcrumbs" class="breadcrumb">
			...
			<li class="current"><a href="/biz/manager/pendingbank">무통장입금목록</a></li>
	</ul>
</div>
<div class="box content_wrap" style="width:1200px !important;">
    <div class="box-table">
        <?php
        ...
        ?>
            ...
            <div class="mt20">전체 : <?php echo element('total_rows', element('data', $view), 0); ?>건</div>
