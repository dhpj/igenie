						...
						<div class="inner_content">
                            ...
                            <table>
                                ...
                                <tr>
                                 ...
                                 <button type="button" id="check_double_id" class="btn md" style="display: inline-block;" onclick="check_duplicated_account('id_userid')">중복 확인</button>

										 <?php }?>

<?if($this->member->item('mem_level')>=100) {?><input type="checkbox" class="uniform" name="useyn" id="useyn" <?=($rs->mem_useyn=="N") ? "checked" : ""?> value="N" /><label for="useyn">삭제</label><?}?>
