...
<!-- 타이틀 영역 END -->
    <div class="account_tab">
        <ul>
            ...
            <li class="selected"><a href="/biz/partner2/partner_sent?<?=$param['key']?>">발신목록</a></li>
	...
	<div id="mArticle">
		<div class="form_section">
			...
			<div class="inner_content">
						...
						<form id="mainForm" name="mainForm" method="post" action="/biz/partner2/partner_sent?<?=$param['key']?>">
                            ...
                            <div class="mb20 mt10 clear">
                                <div class="flLeft">
                                    ...
                                    <input type="text" class="form-control input-width-small inline datepicker"
                                           name="endDate" id="endDate" value="<?=$param['endDate']?>" readonly="readonly" style="cursor: pointer;background-color: white">
	                    ...
	                    <div class="tc">
	                        <a type="button" href="/biz/partner2/edit?<?=$param['key']?>" class="btn md">수정</a>
	                    </div>
			</div>
		</div>
	</div>
    ...
    <script type="text/javascript">
        ...
        function download_use_history() {
            ...
            if(list==''){
                ...
                form.setAttribute("action", "/biz/partner2/partner_download_sent/a01074993322");
