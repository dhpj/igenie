    ...
    <div class="crumbs">
        <ul id="breadcrumbs" class="breadcrumb">
            ...
            <li class="current"><a href="#" title="">일일 통계</a></li>
        </ul>
    </div>
    <div class="snb_nav">
        <ul class="clear">
                ...
                <div class="col-xs-12">
                    <div class="widget">
                        <div class="widget-content">
                            ...
                            <table id="data_grid" class="display cell-border"  style="cursor: default;width: 1422px;">
                             <!--    <colgroup>
                                    <col width="*">
									<col width="60">
                                    <col width="60">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" rowspan="2">요청</th>
                                    <th class="text-center" rowspan="2">성공</th>
                                    <th class="text-center" rowspan="2">실패</th>
                                    <th class="text-center" rowspan="2">대기</th>
                                    <th class="text-center" colspan="7">성공 상세</th>
                                    <th class="text-center" colspan="7">실패 상세</th>
                                </tr>
                                <tr>
                                ...
                                <tbody>
                                    <?$sum_req=0;
                                      ...
                                      $succ = 0;
                                        ...
                                        <tr>
                                            <td class="text-center" style="padding:0;"><? echo $r->mem_username."<BR><div style='background-color: rgb(190, 190, 190);'>".$r->parent_name."</div>"; ?></td>
                                            ...
                                            <td class="text-right" style="padding:8px 1px 8px 0px;"><?=number_format($r->qty_wait)?></td>
