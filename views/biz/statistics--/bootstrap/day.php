...
<!-- 탭메뉴 영역 -->
				<div class="tab_menu">
					<ul>
						<li class=""><a href="/biz/statistics/daily">일일통계</a></li>
						<li class="on"><a href="/biz/statistics/day">구간통계</a></li>
					</ul>
				</div>
<!-- 탭메뉴 영역 END-->
...
<!-- 본문 영역 -->
				<div id="mArticle">
					<div class="rows" style="text-align: center">
						...
						<div class="stat_date_wrap">
							<!--a href="#"><i class="material-icons">keyboard_arrow_left</i></a--><input type="text" name="startDate" id="startDate" value="<?=$param['startDate']?>" readonly="readonly" class="stat_date"><!--a href="#"><i class="material-icons">keyboard_arrow_right</i></a-->
						</div>
					</div>							
					<!-- table start -->
