...
<!-- 탭메뉴 영역 -->
				<div class="tab_menu">
					<ul>
						<li class=""><a href="/biz/statistics/daily">일간</a></li>
						<li class=""><a href="/biz/statistics/day">월간</a></li>
						<li class="on"><a href="/biz/statistics/month">연간</a></li>
					</ul>
				</div>
<!-- 탭메뉴 영역 END-->
...
<!-- 본문 영역 -->
				<div id="mArticle">
					<div class="rows" style="text-align: center">
						<div class="fl">
							<select name="pf_key" id="pf_key" class="selectpicker" data-live-search="true" style="height: 38px;">
						...
						<input type="text" name="startDate" id="startDate" value="<?=$param['startDate']?>" readonly="readonly" class="stat_date">~<input type="text" name="endDate" id="endDate" value="<?=$param['endDate']?>" readonly="readonly" class="stat_date">
					</div>
					<!-- table start -->
								...
								<tbody>
									<?$sum_req=0;
                                      ...
                                      $succ = 0;
                    						  ...
                    						  ?> 
									<tr>
										<td><?=substr($r->mst_datetime, -5)?></td><!-- 발송시간 -->
