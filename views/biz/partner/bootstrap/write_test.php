	...
	<div class="form_section" id="div_id_info">
		...
		<div class="white_box" style="display:inline-block;">
			...
			<ul class="info_contents_wrap">
				...
				<li>
					<label class="info_contents_label icon_must">월사용료</label><?//2020-12-10 추가?>
					<div class="info_contents">
						<input class="input-width-large" id="id_mem_monthly_fee" maxlength="15" name="mem_monthly_fee" placeholder="월사용료" value="<?=number_format($rs->mem_monthly_fee) ?>" type="text" onkeyup="jsNumberFormat(this);">
					</div>
				</li>
				<li>
				...
				<li style="display:<?=($this->member->item('mem_level')>=100) ? "" : "none"?>;">
					<label class="info_contents_label">알림톡 발송시간 해제</label>
					<div class="info_contents">
				...
				<li style="display:<?=($this->member->item('mem_level')>=100) ? "" : "none"?>;">
					<label class="info_contents_label">사용여부</label>
					<div class="info_contents">
				...
				<li>
					<label class="info_contents_label">Purigo 회원</label>
					<div class="info_contents">
