		...
		<div class="white_box">
			<ul class="info_contents_wrap">
				...
				<li>
					...
					<div class="info_contents">
						<input type="radio" id="mem_contract_type_S" name="mem_contract_type" value="S" <?=($rs->mem_contract_type=="S" or $rs->mem_contract_type == "") ? "checked" : ""?> /><label for="mem_contract_type_S"> 스탠다드</label>
