...
<div id="mArticle">
	<div class="form_section">
		<div class="inner_tit">
			<h3>파트너 목록 (전체 <b style="color: red" id="total_rows">0</b>개)</h3>
		...
		<div class="white_box" id="search_box">
            <div class="search_box">
				...
				<span style="margin-left:10px;">휴면상태</span><!-- 2021.12.30 조지영 추가 -->
                ...
                <table>
                	...
                	<tbody>
                		...
                		<tr>
                			...
                			<td>
                				<input type="button" style="height:25px;" class="btn_userinsert" value="<?=($this->member->item('mem_level')==17)? "계정보기" : "계정수정"?>" onclick="document.location.href='/biz/partner/view?<?=$row->mem_userid?>'"/>
                			...
                			<td class='show_modal' data-mid='<?=$row->mem_id?>' data-un='<?=$row->mem_username?>'><?=$row->mem_nickname?></td><?//담당자 이름?>
...
<script>
    ...
    }).on('click', '.show_modal', function(){
        mid = $(this).data('mid');
        $('#patner_name').html($(this).data('un'));
        open_modal(false);
    });
    ...
    function open_page(page) {
        ...
        form.setAttribute("action", "/biz/partner/lists");
