...
?>
					...
					<p>후불제</p>
					<? } ?>
					<div class="fee_box" id="id_SentNumber">
						<ul>
					...
					<div class="fee_box" id="id_SentUnitPrice" style="display:none;">
						<ul>
				...
				<div class="pf_shop">
					<? if($this->member->item('mem_contract_type') == "S"){ //계약형태 (S.스텐다드, P.프리미엄) ?>
						<a href="/mall/info"><span class="material-icons">add_shopping_cart</span> 쇼핑몰 바로가기</a>
					<? }else{ ?>
				...
				<div class="snb_menu">
					<ul id="accordion" class="accordion">
						...
						<? } //if($this->member->item('mem_level') >= 50){ //중간관리자 이상 권한만 보임 ?>
						<li<?=(strpos("/".$req_url, "/mall/compare") == true) ? " class='open'" : ""?>>
							<a href="/mall/compare"><div class="link"><span class="material-icons">ballot</span>스마트전단 샘플</div></a>
						</li>
						<li<?=(strpos("/".$req_url, "/pop/screen") == true) ? " class='open'" : ""?>>
							<a href="/pop/screen"><div class="link"><span class="material-icons">format_shapes</span>스마트전단 목록</div></a>
						</li>
