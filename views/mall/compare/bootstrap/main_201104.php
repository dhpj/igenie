<div class="wrap_compare">
  ...
  <div class="write_leaflets">
    ...
    <div class="wl_rbox">
      <div class="wl_r_preview" id="div_preview">
        <!--
		<div class="pre_box_wrap">
          <?//템플릿 이미지가 들어갈 공간?>
          <div class="wl_r_preview_bg" style="background:url('/dhn/images/leaflets/tem/tem01.jpg') no-repeat top center;background-color:#47b5e5;"></div>
          <?//템플릿 이미지가 들어갈 공간?>
          <div class="pre_box1">
            <p class="pre_tit">주말한정특가</p>
            <p class="pre_date">2020.10.03 ~ 2020.10.04</p>
          </div>
          <div class="pre_box2">
            <?//상품추가시 looping?>
            <dl>
              <dt>
                <div class="sale_badge" style="display:;">25<span>%</span></div>
                <img src="/dhn/images/leaflets/sample_img.jpg" alt=""/>
              </dt>
              <dd>
                <ul>
                  <li class="price1">4,000원</li>
                  <li class="price2">3,000원</li>
                  <li class="name">농심 신라면 120g 5입 1+1</li>
                </ul>
              </dd>
            </dl>
            <dl>
        ...
        <div class="pre_box_wrap">
          <div class="pre_box3">
            <p class="pre_tit"><img src="/dhn/images/leaflets/title/type4/02.jpg" alt=""></p>
            <div class="pop_list_wrap">
            <?//상품추가시 looping?>
            <div class="pop_list01">
              <div class="pop_good_img">
                <img src="/dhn/images/leaflets/sample_img.jpg" alt=""/>
              </div>
              <div class="pop_price">
                <p class="price1">4,000원</p>
                <p class="price2">3,000원</p>
              </div>
              <div class="pop_name">
                  신라면5입
              </div>
          ...
          <div class="pre_box4">
            <p class="pre_tit"><img src="/dhn/images/leaflets/title/type4/03.jpg" alt=""></p>
              <div class="pop_list_wrap">
                <?//상품추가시 looping?>
                <div class="pop_list02">
                   <span class="name">신라면5입</span>
                   <span class="price1">4,000원</span>
                   <span class="price2">3,000원</span>
                </div>
                <div class="pop_list02">
                   <span class="name">신라면5입</span>
                   <span class="price1">4,000원</span>
	...
	function preview(code, scroll_yn){
		...
		$.ajax({
			...
			success: function (json) {
				...
				html += "            <!--상품추가시 looping-->";
				//STEP1 시작
				if(json.screen_data["psd_step1_yn"] != ""){ //STEP1 시작
				...
				html += "        <div class=\"pre_box_wrap\">";
				//STEP2 시작
				if(json.screen_data["psd_step2_yn"] != ""){ //STEP2 시작
				...
				//STEP3 시작
				if(json.screen_data["psd_step3_yn"] != ""){ //STEP3 시작
