...
<div class="wrap_order">
  ...
  <div class="order_content">
    ...
    <ul class="registration">
      <li><input type="text" id="input_name" placeholder="이름(선택입력)" value=""></li>
      <li><input type="text" id="input_tel" placeholder="전화번호 입력" value="" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"></li>
      <li><input type="text" id="input_addr" placeholder="주소 입력" value=""></li>
      <li><button class="btn_map_add" onclick="input_add()"><i class="xi-plus-circle-o"></i> 지도등록</button></li>
    </ul>
    <!--//배달주소 직접등록-->
    <div class="s_tit2">
