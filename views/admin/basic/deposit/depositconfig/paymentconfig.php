            ...
            <div class="form-horizontal">
                ...
                <div class="form-group" id="kcp_info_anchor">
                    <div class="pg_info pg_kcp clearfix">
                        <div class="col-sm-2 control-label">
                            <label for="pg_kcp_mid">KCP SITE CODE</label><br>
                            <a href="http://sir.kr/main/service/p_pg.php" target="_blank" id="scf_kcpreg" class="kcp_btn">NHN KCP서비스신청하기</a>
                        </div>
                        <div class="col-sm-10 form-inline">
                            <span class="sitecode"></span> <input type="text" class="form-control pg_input" name="pg_kcp_mid" id="pg_kcp_mid" value="<?php echo set_value('pg_kcp_mid', element('pg_kcp_mid', element('data', $view))); ?>" />
                ...
                <div class="form-group" id="lg_info_anchor">
                    <div class="pg_info pg_lg clearfix">
                        <div class="col-sm-2 control-label">
                            <label for="pg_lg_mid">LG유플러스 상점아이디</label><br>
                            <a href="http://sir.kr/main/service/lg_pg.php" target="_blank" id="scf_lgreg" class="lg_btn">LG유플러스 서비스신청하기</a>
                        </div>
                        <div class="col-sm-10 form-inline">
                            <span class="sitecode"></span> <input type="text" class="form-control pg_input" name="pg_lg_mid" id="pg_lg_mid" value="<?php echo set_value('pg_lg_mid', element('pg_lg_mid', element('data', $view))); ?>" />
                            <div class="help-block">LG유플러스에서 받은 상점 ID를 입력하세요.<br></div>
                        </div>
                    </div>
                    <div class="pg_info pg_lg clearfix">
                ...
                <div class="form-group" id="inicis_info_anchor">
                    <div class="clearfix pg_info pg_inicis">
                        <div class="col-sm-2 control-label">
                            <label for="pg_inicis_mid">KG이니시스 상점아이디</label><br>
                            <a href="http://sir.kr/main/service/inicis_pg.php" target="_blank" id="scf_lgreg" class="kg_btn">KG이니시스 서비스신청하기</a>
                        </div>
                        <div class="col-sm-10 form-inline">
                            <span class="sitecode"></span> <input type="text" class="form-control pg_input" name="pg_inicis_mid" id="pg_inicis_mid" value="<?php echo set_value('pg_inicis_mid', element('pg_inicis_mid', element('data', $view))); ?>" />
                            <div class="help-block">
                            KG이니시스로 부터 발급 받으신 상점아이디(MID) 10자리를 입력 합니다.<br>
                            </div>
                        </div>
                    </div>
                    <div class="clearfix pg_info pg_inicis">
