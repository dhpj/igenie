        ...
        ?>
            ...
            <div class="box-table">
                <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label"><?php echo $this->depositconfig->item('deposit_name'); ?> 변동</label>
                            <div class="col-sm-10">
                                <?php
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">현금 / 카드</label>
                            <div class="col-sm-10">
                                <?php echo number_format(element('dep_cash', element('data', $view))); ?> 원
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">보너스 포인트</label>
                            <div class="col-sm-10">
