                ...
                <table class="table table-hover table-striped">
                    ...
                    ?>
                        <tr class="success">
                            ...
                            <td>
                                <div class="form-group form-group-sm">
                                    <select name="men_show[<?php echo element(element('primary_key', $view), $result); ?>]" class="form-control input-sm">
                                        <option value="Y" <?php echo (element('men_show', $result) == 'Y') ? 'selected="selected"' : ''; ?>>표시</option>
                                        <option value="N" <?php echo (element('men_show', $result) != 'Y') ? 'selected="selected"' : ''; ?>>숨김</option>
                                    </select>
                                </div>
                            </td>
                            <td>
                                <div class="form-group form-group-sm">
                                    <input type="text" name="men_allow_lv[<?php echo element(element('primary_key', $view), $result); ?>]" class="form-control input-sm" value="<?php echo html_escape(element('men_allow_lv', $result)); ?>" />
                                </div>
                            </td>
                            <td>
                                <div class="form-group form-group-sm">
                                    <input type="text" name="men_max_lv[<?php echo element(element('primary_key', $view), $result); ?>]" class="form-control input-sm" value="<?php echo html_escape(element('men_max_lv', $result)); ?>" />
                                </div>
                            </td>
                            <td>
                                <div class="form-group form-group-sm">
                        ...
                        <tr class="warning">
                            ...
                            <td>
                                <div class="form-group form-group-sm">
                                    <select name="men_show[<?php echo element(element('primary_key', $view), $subresult); ?>]" class="form-control input-sm">
                                        <option value="Y" <?php echo (element('men_show', $subresult) == 'Y') ? 'selected="selected"' : ''; ?>>표시</option>
                                        <option value="N" <?php echo (element('men_show', $subresult) != 'Y') ? 'selected="selected"' : ''; ?>>숨김</option>
                                    </select>
                                </div>
                            </td>
                            <td>
                                <div class="form-group form-group-sm">
                                    <input type="text" name="men_allow_lv[<?php echo element(element('primary_key', $view), $subresult); ?>]" class="form-control input-sm" value="<?php echo html_escape(element('men_allow_lv', $subresult)); ?>" />
                                </div>
                            </td>
                            <td>
                                <div class="form-group form-group-sm">
                                    <input type="text" name="men_max_lv[<?php echo element(element('primary_key', $view), $subresult); ?>]" class="form-control input-sm" value="<?php echo html_escape(element('men_max_lv', $subresult)); ?>" />
                                </div>
                            </td>
                            <td>
                                <div class="form-group form-group-sm">
