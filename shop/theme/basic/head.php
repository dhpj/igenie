...
<!-- 콘텐츠 시작 { -->
	<div id="container"  class="sub_<?php echo $co_id.$bo_table;?><?php if(strpos($_SERVER["PHP_SELF"], 'bbs/faq') == true){?>faq<?php } ?><?php if(strpos($_SERVER["PHP_SELF"], 'bbs/qalist') == true){?>qa<?php } ?>">
		<?php if (($bo_table || $w == 's'  || strpos($_SERVER["PHP_SELF"], 'bbs/faq') == true || strpos($_SERVER["PHP_SELF"], 'bbs/qalist') == true) && !defined("_INDEX_")) { ?><div class="wrap"><?php } ?>